...
public class User implements Parcelable {
    ...
    @ColumnInfo(name = "feedbackStatus")
    ...
    protected User(Parcel in) {
        ...
        lastUser = in.readByte() != 0;
        feedbackStatus = in.readByte() != 0;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByte((byte) (feedbackStatus ? 1 : 0));
        parcel.writeByte((byte) (lastUser ? 1 : 0));
    }
