...
Game.grade6_1level1.prototype={
    ...
    var starsGroup;
        ...
        background = this.add.tileSprite(0,0,this.world.width,this.world.height, 'Level61_bg2');
  ...
  /*      _this.speakerbtn.events.onInputDown.add(function(){
    ...
    gotoFirstQuestion:function(){
        ...
        _this.questionid = "6.1_1#SCR-"+_this.sceneCount;
...
//     }, this);                
    ...
    checkAns:function(target,group,len,extraparam=null)
    {
         noofAttempts++;
        ...
        switch(voices[0])
        {
          ...
          case "Wednesday" :if(group=="wedgrp")
            ...
            case "lastDay" : if(months.name == "january"||months.name == "march"||months.name == "may"||months.name ==                          "august"||months.name == "october")
                             {
                                 if(target.frame==31){
                                     var circleanimfirstAnim=this.add.sprite(100, 100, 'Level61_g3','Symbol 1 copy 14 instance 10000');
                                     circleanimfirstAnim.alpha=1;
                             ...
                             if(months.name == "june"||months.name == "november")
                             {
                                 if(target.frame==30){
                                      var circleanimfirstAnim=this.add.sprite(100, 100, 'Level61_g3','Symbol 1 copy 14 instance 10000');
                                 circleanimfirstAnim.alpha=1;
                                ...
                                shake.shake(10,target);
                                 ...
                                 if(months.name == "september"||months.name == "december"){
                                     if(target.frame==30){
                                     var circleanimfirstAnim=this.add.sprite(100, 100, 'Level61_g2','Symbol 1 copy 15 instance 10000');
                                         circleanimfirstAnim.alpha=1;
                                circleanimfirstAnim.x=target.x+20;
                            ...
                            if(months.name == "april"||months.name == "july")
                             {
                                 if(target.frame==29){
                                     var circleanimfirstAnim=this.add.sprite(100, 100, 'Level61_g2','Symbol 1 copy 15 instance 10000');
                                     circleanimfirstAnim.scale.setTo(0.74,1);
