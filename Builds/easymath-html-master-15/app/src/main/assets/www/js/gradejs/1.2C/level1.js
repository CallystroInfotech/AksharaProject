...
Game.grade1_2Clevel1.prototype={
	...
	create:function(game){
       ...
       _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'Level12A_background');
	...
	displayQuestion:function()
	{
		...
		{
			case 1: _this.questionid = "1.2C1#SCR-"+_this.sceneCount;_this.addFirstWindMill(); break;
			case 2: _this.questionid = "1.2C2#SCR-"+_this.sceneCount;_this.addFirstWindMill(); break;
			case 3: _this.questionid = "1.2C3#SCR-"+_this.sceneCount;_this.addFirstWindMill(); break;
			case 4: _this.questionid = "1.2C1#SCR-"+_this.sceneCount;_this.addSixthWindMill(); break;
			case 5: _this.questionid = "1.2C2#SCR-"+_this.sceneCount;_this.addSixthWindMill(); break;
			case 6: _this.questionid = "1.2C3#SCR-"+_this.sceneCount;_this.addSixthWindMill(); break;
			case 7: _this.questionid = "1.2C1#SCR-"+_this.sceneCount;_this.addSeventhWindMill(); break;
			case 8: _this.questionid = "1.2C2#SCR-"+_this.sceneCount;_this.addSeventhWindMill(); break;
			case 9: _this.questionid = "1.2C3#SCR-"+_this.sceneCount;_this.addSeventhWindMill(); break;
...
//		_this.checkButton.addChild(checktext);
		...
		_this.checkButton.events.onInputDown.add(function(){_this.checkButton.frame = 0;
                                                      _this.ClickSound = _this.add.audio('ClickSound');
        _this.ClickSound.play();
