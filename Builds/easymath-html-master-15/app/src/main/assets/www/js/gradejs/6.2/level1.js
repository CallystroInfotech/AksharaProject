...
Game.grade6_2level1.prototype={
	...
	create:function(game){
        ...
        background = this.add.tileSprite(0,0,this.world.width,this.world.height, 'Level62_bg2');
  ...
  return array;
    ...
    gotoFirstQuestion:function(){
         _this.questionid = "6.1_2#SCR-"+_this.sceneCount;
        //january
    	no11++;
        val=1;
   ...
   checkAns:function(target,group,len)
    ...
    checkdays:function(target,dayarray){
       ...
       _this.clickSound = _this.add.audio('ClickSound');
            _this.clickSound.play();
        var circleanim;
        if(dayarray.includes(Number(voices[0])))
        {
