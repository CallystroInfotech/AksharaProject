...
Game.grade2_1Alevel1.prototype={
    ...
    create:function(game){
           ...
           // var backbtn = _this.add.button(5,2,'backbtn',function(){//console.log("here");},_this,0,1,2);
           // _this.speakerbtn = _this.add.button(910,2,'_this.speakerbtn',function(){_this.speakeron();},_this,1,0,2);
    ...
    gotoThirdQuestion:function(){
       ...
       _this.cloud = _this.add.sprite(100,50,'Level21_cloud');
       _this.cloud.scale.setTo(1,1); 
    _this.mainFlag = _this.add.sprite(270,100,'Level21_bird1');
    _this.mainFlag.anchor.setTo(0.5);
       _this.mainFlag.inputEnabled = true;
    _this.mainFlag.input.useHandCursor = true;
