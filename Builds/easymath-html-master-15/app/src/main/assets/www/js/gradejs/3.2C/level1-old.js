...
Game.grade3_2Clevel1.prototype={
    create:function(game){
       ...
       // qArrays = this.shuffle(qArrays);
        ...
        bg1 = this.add.tileSprite(0,0,this.world.width,this.world.height,'Level32C_level2Bg');
  ...
  return array;
    ...
    addNumberPad:function(){
        ...
        for(var i=0;i<10;i++)
        {
            var numbg = numGroup.create(x,500,'Level32C_numbg');  
        ...
        var txtbox = this.add.sprite(x+50,500,'Level32C_txtbox');
        txtbox.anchor.setTo(0.5);
        txtbox.name = "txtbox";
        
        var wrongbtn = numGroup.create(x+120,500,'Level32C_wrongBtn');
        ...
        var rightbtn = numGroup.create(x+170,500,'Level32C_rightBtn');
        ...
        enterTxt.setShadow(0, 0,'Level32C_rgba(0, 0, 0, 0)', 0);
...
//                    anim2.play(10);
    ...
    gotoFirstQuestion:function(){
        if(window.languageSelected=="English")
                    {
                        ElevelCa.play();
                        ElevelCa.onStop.add(function(){/*//console.log("here");*/this.input.enabled = true;}, this);
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        HlevelCa.play();
    ...
    Voice1:function(question){
        ...
        if(window.languageSelected=="English")
        ...
        else
            {
                ...
                {
                        ElevelCb.play();
                        ElevelCb.onStop.add(function(){/*//console.log("here");*/this.input.enabled = true;}, this);
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        HlevelCb.play();
