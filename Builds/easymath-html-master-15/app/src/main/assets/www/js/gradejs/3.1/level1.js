...
Game.grade3_1level1.prototype={
	...
	create:function(game){
       ...
       // baudio.play(); 
        ...
        _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'Level31_bg1');
        //_this.bg1.scale.setTo(1.05,1.12);
		
       /* var backbtn = _this.add.button(5,1,'Level31_CommonBackBtn',function(){
			_this.stopAllVoice();
   ...
   getVoice:function(){
    ...
    gotoThirdQuestion:function(){
    	...
    	_this.mainFlag = _this.add.sprite(330,370,'Level31_leaf1');
    	_this.mainFlag.anchor.setTo(0.5);
         _this.mainFlag.scale.setTo(1,1.1);
        _this.mainFlag.inputEnabled = true;
    _this.mainFlag.input.useHandCursor = true;
        _this.mainFlag.name = 'Level31_leaf';
        _this.mainFlag.events.onInputDown.add(_this.correctAns,_this);
        
        _this.sh1= _this.add.sprite(670,430,'Level31_sh4');
        _this.sh1.anchor.setTo(0.5); 
         
    	_this.opt1 = _this.add.sprite(680,260,'Level31_bottle1');
        _this.opt1.name = "Level31_bottle";
    	_this.opt1.anchor.setTo(0.5);
   ...
   gotoSixthQuestion:function(){
    ...
    gotoEighthQuestion:function(){
      ...
      gotoEleventhQuestion:function(){
    	...
    	_this.mainFlag = _this.add.sprite(250,180,'Level31_bee1');
    	_this.mainFlag.anchor.setTo(0.5);
        _this.mainFlag.scale.setTo(1,1.2);
        _this.mainFlag.inputEnabled = true;
    	_this.mainFlag.input.useHandCursor = true;
        _this.mainFlag.name = 'Level31_bee';
        _this.mainFlag.events.onInputDown.add(_this.correctAns,_this);
        
        _this.sh1 = _this.add.sprite(680,455,'Level31_sh11');
        _this.sh1.anchor.setTo(0.5); 
         
    	_this.opt1 = _this.add.sprite(630,310,'Level31_elephant1');
        _this.opt1.name = "Level31_elephant";
    	_this.opt1.anchor.setTo(0.5);
        _this.opt1.scale.setTo(1,1.1);
        _this.opt1.inputEnabled = true;
    	_this.opt1.input.useHandCursor = true;
    ...
    // switch(_this.no1)
    	{
    		case 1: 
                    _this.questionid = "3.1_1#SCR-"+_this.sceneCount;
                    _this.gotoFirstQuestion();
    				break;
    		case 2: 
                    _this.questionid = "3.1_2#SCR-"+_this.sceneCount;
