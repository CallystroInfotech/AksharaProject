...
init:function(game)
    ...
    addNumberPad:function(){
        ...
        txtbox = this.add.sprite(x+30,505,'Level42A_box','Symbol 30 copy instance 10001');
        ...
        wrongbtn = numGroup.create(x+120,505,'Level42A_eraser','Symbol 14 copy 5 instance 10000');
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.scale.setTo(0.95,0.98);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+175,506,'Level42A_rightBtn','Symbol 14 copy instance 10000');
