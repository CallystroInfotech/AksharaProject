...
Game.grade5_2level1.prototype={
	...
	create:function(game){
        ...
        background = this.add.tileSprite(0,0,this.world.width,this.world.height-50, 'Level52_Bg');
        ...
        _this.speakerbtn = _this.add.sprite(908,5,'CommonSpeakerBtn');
    ...
    getslides:function()
	{
		...
		_this.questionid = "5.2#SCR-"+_this.sceneCount;
