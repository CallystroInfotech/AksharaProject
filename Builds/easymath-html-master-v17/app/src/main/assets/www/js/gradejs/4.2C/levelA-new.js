   ...
   /* getVoice:function(question){
    ...
    {   
        ...
        if(window.languageSelected == "English")
                    {
                        _this.src.setAttribute("src", "questionSounds/4.2A/English/4.2C1.mp3");
                    }
                    else if(window.languageSelected == "Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/4.2A/Hindi/4.2C1.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/4.2A/Kannada/4.2C1.mp3");
                    }
