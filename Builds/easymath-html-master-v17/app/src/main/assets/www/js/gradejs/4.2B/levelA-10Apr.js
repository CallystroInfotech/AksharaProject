...
init:function(game)
    ...
    gotoSecondQuestion:function(){
         ...
         var red1 = this.add.sprite(225,260,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(425,230,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
      ...
      gotoThirdQuestion:function(){
       ...
       gotoFourthQuestion:function(){
         var red1 = this.add.sprite(165,203,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(430,190,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(682,245,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	  no1++;
          i=1;
          j=1;
     ...
     gotoFifthQuestion:function(){
         var red1 = this.add.sprite(194,245,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(496,243,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(683,275,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
  ...
  wronggraphics3.alpha = 0;
    ...
    gotoSixthQuestion:function(){
     ...
     gotoSeventhQuestion:function(){
         var red1 = this.add.sprite(167,224,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
     ...
     wronggraphics2.alpha = 0;
      ...
      gotoEighthQuestion:function(){
         var red1 = this.add.sprite(215,235,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
...
//            starsGroup1.visible=false;
    ...
    addNumberPad:function(){
        ...
        var x = 80;
		var footer = this.add.sprite(0,467,'Level42B_footer');
		numGroup.add(footer);
        for(var i=0;i<10;i++)
        {
     ...
     //   txtbox.anchor.setTo(0.5);
      //  txtbox.name = "txtbox";
        ...
        wrongbtn = numGroup.create(x+30,502,'Level42A_eraser');
        wrongbtn.anchor.setTo(0.5);
        //wrongbtn.scale.setTo(0.5,0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+90,502,'Level42A_rightBtn');
       ...
       // rightbtn.scale.setTo(0.5,0.5);
		...
		boxGroup.y=50;
		numGroup.y=50;
		var Maintween1 = this.add.tween(boxGroup);
        Maintween1.to({ y:0}, 0, 'Linear', true, 0);
