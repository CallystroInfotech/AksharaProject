...
gotoTenthQuestion:function(){
 ...
 addNumberPad:function(){
        ...
        _this.box1 = _this.numGroup.create(480,500,'unity11_2b2');
        _this.box1.anchor.setTo(0.5);
        
        _this. x = 80;
        for(var i=0;i<10;i++)
        {
            _this. numbg = _this.numGroup.create(_this.x,500,'unity11_2numberpad');  
        ...
        _this.wrongbtn = _this.numGroup.create(_this.x+30,500,'unity11_2erase');
        ...
        _this.rightbtn = _this.numGroup.create(_this.x+90,500,'unity11_2rightmark');
      ...
      _this.wrongbtn.events.onInputDown.add(function(){_this.clickSound.play();_this.enterTxt.setText("");_this.selectedAns="";},_this);
