       ...
       // _this.CaterpillarWhiteCopy.add(_this.Caterpillar_body_head_2Copy);
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_1start', 30, true);
	...
	correctAns:function(target)
	{
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            if (_this.Caterpillar_head.key == 'Unity2_5_1start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_1Caterpillar_Happy',null,true);
            }
             //_this.wrong = true;
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_1wrong',null,true);
            }
