    ...
    init:function(game)
 {
  ...
  return array;
    ...
    _this.timer.start();
        ...
        dragcount = 0;
         this.questionid = "Game6.1#SCR-"+this.sceneCount;
    	switch(qArrays[no11])
       //switch(no11)
    	{
    		case 1: 
...
//timer.setText(minutes + ':'+ seconds );
    ...
    gotoFirstQuestion:function(){
        ...
        var RabitAnim = this.add.sprite(140,386,'grade61_RabitAnim','Symbol 2 instance 10000');
...
//        WhiteBox.addChild(greenNumbers2);
      ...
      // this.allfalse();
        ...
        bottomBar.name="grade61_bottomBar";
            ...
            var calNum1=this.add.sprite(120,505,'grade61_calNum');
...
//            }
            ...
            var calNum2=this.add.sprite(180,505,'grade61_calNum');
...
//            }
            ...
            var calNum3=this.add.sprite(240,505,'grade61_calNum');
...
//            }
            ...
            var calNum5=this.add.sprite(360,505,'grade61_calNum');
...
//            }
            ...
            var calNum6=this.add.sprite(420,505,'grade61_calNum');
...
//            }
            ...
            var calNum7=this.add.sprite(480,505,'grade61_calNum');
...
//            }
            ...
            var calNum8=this.add.sprite(540,505,'grade61_calNum');
...
//            }
            ...
            var calNum9=this.add.sprite(600,505,'grade61_calNum');
...
//            }
            ...
            var calNum0=this.add.sprite(660,505,'grade61_calNum');
...
//            }
       ...
       //console.log("pressed=="+pressed);
            ...
            tick=this.add.sprite(820,505,'grade61_tick');
        tick.name="grade61_tick";
           ...
           tick.input.useHandCursor = true;
            ...
            eraser=this.add.sprite(740,505,'grade61_eraser');
