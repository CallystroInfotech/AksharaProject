...
Game.grade3_3B1level1.prototype={
	...
	create:function(game){
     ...
     /*   objArray = [
        ...
        bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'Level33B1_Newlevel2Bg');
  ...
  return array;
    ...
    {       
        ...
        _this.questionid = "3.3B_1#SCR-"+_this.sceneCount;
  ...
  /*  stopAllVoice:function(){
    ...
    addNumberPad:function(){
        ...
        for(var i=0;i<10;i++)
        {
            var numbg = numGroup.create(x,500,'Level33B1_Newnumbg');  
        ...
        var txtbox = this.add.sprite(x+35,500,'Level33B1_Newtxtbox');
        txtbox.anchor.setTo(0.5);
        txtbox.name = "txtbox";
        
        if(window.languageSelected=="English")
            kgTxt = this.add.text(x+110,500, "Kgs");
        else if(window.languageSelected=="Hindi")
            kgTxt = this.add.text(x+110,500, "कि.ग्रा ");
         else
            kgTxt = this.add.text(x+110,500, "ಕೆಜಿ");
        ...
        var wrongbtn = numGroup.create(x+180,500,'Level33B1_NewwrongBtn');
        ...
        var rightbtn = numGroup.create(x+230,500,'Level33B1_NewrightBtn');
    ...
    /*
       ...
       // object2 = this.add.sprite(this.world.centerX+350,440,objArray[qArrays[count]][1]);
        ...
        object2 = this.add.sprite(this.world.centerX+300,180,'Level33B1_New1kg');
        object2.name = "1kg";
        object2.anchor.setTo(0.5,1);
        // obj2.addChild(object2);
