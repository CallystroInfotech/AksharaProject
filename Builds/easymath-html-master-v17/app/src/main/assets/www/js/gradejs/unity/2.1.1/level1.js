...
Game.unity2_1_1level1.prototype ={
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_1_1_Caterpillar_Neutral', 30, true);
       ...
       // _this.opt2.frame = 1;
        ...
        _this.Caterpillar_head1.animations.play('unity2_1_1_Caterpillar_Neutral', 30, true);
    ...
    wrongAns:function(target)
	{
       ...
       // target.tint = 0xA9A9A9;
        ...
        if (_this.Caterpillar_head1.key === 'Caterpillar_Neutral')
        {
            _this.Caterpillar_head1.loadTexture('Caterpillar_Sad', 0, false);
        }
