...
Game.grade7_1level1.prototype={
	...
	create:function(game){
     ...
     _this.randomgrp;
      ...
      _this.backbtn = _this.add.sprite(5,1,'Level71_CommonBackBtn');
       ...
       _this.speakerbtn = _this.add.sprite(908,1,'Level71_CommonSpeakerBtn');
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX, 15, 'Level71_starAnim');
			for(var j =0;j<i;j++)
			{
