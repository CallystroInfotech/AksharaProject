...
//timer.setText(minutes + ':'+ seconds );
 ...
 gotoFirstQuestion:function(){
		...
		_this.questionid = "4.3C1#SCR-"+_this.sceneCount;
        ...
        eqnum = 0;
         ...
         b6 = this.add.sprite(690,403,'Level43A_arrowC');
         b6.anchor.setTo(0.5,1);
         b6.name = "arrowC";
		 
		 if(window.languageSelected=="English"){
            kgTxt = this.add.text(738,390, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
         else if(window.languageSelected=="Hindi"){
				kgTxt = this.add.text(752,392, "मि.ली ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
			}
          else{
				kgTxt = this.add.text(749,392, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
		   }
    ...
    gotoSecondQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
          if(window.languageSelected=="English"){
            kgTxt = this.add.text(738,356, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
         else if(window.languageSelected=="Hindi"){
				kgTxt = this.add.text(752,358, "मि.ली ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
			}
          else{
				kgTxt = this.add.text(749,358, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
		   }
    ...
    gotoThirdQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6 = this.add.sprite(690,313,'Level43A_arrowC');
         b6.anchor.setTo(0.5,1);
         b6.frame = 2;
         b6.name = "arrowC";
		 
		  if(window.languageSelected=="English"){
				kgTxt = this.add.text(738,297, "ml");
				kgTxt.font = 'myfont';
				kgTxt.fontWeight = 'normal'
				kgTxt.fontSize = 20;
		 }
         else if(window.languageSelected=="Hindi"){
				kgTxt = this.add.text(752,302, "मि.ली ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
			}
          else{
				kgTxt = this.add.text(750,302, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
		   }
    ...
    gotoFourthQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(757,256, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
   ...
   gotoFifthQuestion:function(){
		...
		_this.questionid = "4.3D1#SCR-"+_this.sceneCount;
                questionNo = 5;
       this.getVoice();
        //console.log("Question number "+questionNo);
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(650,343, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
    ...
    gotoSixthQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(650,375, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
         else if(window.languageSelected=="Hindi"){
				kgTxt = this.add.text(650,378, "मि.ली ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
			}
          else{
				kgTxt = this.add.text(650,378, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
		   }
    ...
    gotoSeventhQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(650,278, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
         else if(window.languageSelected=="Hindi"){
				kgTxt = this.add.text(653,281, "मि.ली ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
			}
          else{
    ...
    gotoEighthQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(650,245, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
    ...
    gotoNinthQuestion:function(){
        ...
        eqnum = 0;
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(650,207, "ml");
			kgTxt.font = 'myfont';
			kgTxt.fontWeight = 'normal'
			kgTxt.fontSize = 20;
		 }
