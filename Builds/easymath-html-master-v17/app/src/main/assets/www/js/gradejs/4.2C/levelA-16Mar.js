...
init:function(game)
    ...
    question1:function()
    {
        ...
        box1=this.add.sprite(120,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(400,410,'Level42C_box');
    ...
    question2:function()
    {
        ...
        box1=this.add.sprite(132,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(393,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question3:function()
    {
        ...
        box1=this.add.sprite(110,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(413,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question4:function()
    {
        ...
        box1=this.add.sprite(116,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(405,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question5:function()
    {
        ...
        box1=this.add.sprite(125,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
    ...
    question6:function()
    {
        ...
        box2=this.add.sprite(394,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question7:function()
    {
        ...
        box1=this.add.sprite(105,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(390,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question8:function()
    {
        ...
        box1=this.add.sprite(140,410,'Level42C_box');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(391,410,'Level42C_box');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    addNumberPad:function(){
        ...
        wrongbtn = numGroup.create(x+50,502,'Level42C_eraser','Symbol 1 instance 10000');
        wrongbtn.scale.setTo(0.5,0.5);
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+100,502,'Level42C_rightBtn','Symbol 2 instance 10000');
    ...
    numClicked:function(target){
        ...
        if(boxclick=="opt1box")
        {
            ...
            if(selectedAns1.length<2)
            {
                ...
                console.log("opppppp"+selectedAns1);
        ...
        {        
            ...
            if(selectedAns2.length<2)
            {
                ...
                console.log("dddd"+selectedAns2);
                maskbg.kill();
                console.log("qqqq==="+questarrayC[qnoC]);
