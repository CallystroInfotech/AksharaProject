...
init:function(game)
    ...
    create:function(game){
       ...
       _this.speakerbtn = _this.add.sprite(640,9,'Level42A_CommonSpeakerBtn');
    ...
    var timebg=this.add.sprite(270,9,'Level42C_timer');
    timebg.scale.setTo(1.2,1);
        
    timeDisplay = this.add.text(302,25,minutes + ' : '+ seconds);
    ...
    generateStarsForTheScene:function(count)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            starsGroupC.create(this.world.centerX, 11, 'Level42A_CommonStarAnim');
            for(var j =0;j<i;j++)
            {
    ...
    {   
        ...
        _this.questionid = "4.2_C1#SCR-"+_this.sceneCount;
    ...
    question1:function()
    {
        ...
        box1=this.add.sprite(120,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(400,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question2:function()
    {
        ...
        vessel1c = this.add.sprite(607,201,'Level42C_cooker1','<Group>_73 copy 2 instance 10000');
        ...
        box1=this.add.sprite(132,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(393,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question3:function()
    {
        ...
        orangecanc = this.add.sprite(27,137,'Level42C_can1','<Group>_51 copy 2 instance 10000');
        orangecanc.width+=30;
        ...
        box1=this.add.sprite(110,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(413,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question4:function()
    {
        ...
        bluecanc = this.add.sprite(621,140,'Level42C_can1','<Group>_51 copy 2 instance 10001');
        ...
        box1=this.add.sprite(116,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(405,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question5:function()
    {
        ...
        bluebucketc = this.add.sprite(601,160,'Level42C_bluebucketc2','<Group>_15 copy 2 instance 10001');
        ...
        box1=this.add.sprite(125,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
    ...
    question6:function()
    {
        ...
        //bottlec_shadow.height+=10;
        greenmugc_shadow = this.add.sprite(648,382,'Level42C_common_shadow');
        ...
        greenmugc = this.add.sprite(612,113,'Level42C_greenmugc1','<Group>_57 copy 2 instance 10000');
        ...
        redmark=this.add.sprite(780,165,'Level42C_redmark');
        redmark.scale.setTo(0.75,0.75);
        ...
        box2=this.add.sprite(394,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question7:function()
    {
        ...
        vessel2c = this.add.sprite(585,90,'Level42C_vessel1','<Group>_73 copy 2 instance 10001');
        ...
        redmark=this.add.sprite(813,190,'Level42C_redmark');
        redmark.scale.setTo(0.75,0.75);
        
        box1=this.add.sprite(105,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(390,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
    ...
    question8:function()
    {
        ...
        //bottlec_shadow.height+=10;
        bluepotc_shadow = this.add.sprite(652,383,'Level42C_common_shadow');
        bluepotc_shadow.width-=95;
        bluepotc_shadow.alpha=0.5;
        greencupreverse = this.add.sprite(40,253,'Level42C_greena1');
        ...
        bluepotc = this.add.sprite(613,110,'Level42C_potsplash1','<Group>_90 copy 2 instance 10001');
        ...
        redmark=this.add.sprite(775,176,'Level42C_redmark');
        redmark.scale.setTo(0.75,0.75);
        
        box1=this.add.sprite(140,410,'Level42C_box','Symbol 30 copy instance 10001');
        box1.scale.setTo(0.85,0.65);
        box1.alpha=0;
        box1.name="opt1box";
         
        box2=this.add.sprite(391,410,'Level42C_box','Symbol 30 copy instance 10001');
        box2.scale.setTo(0.85,0.65);
        box2.alpha=0;
        box2.name="opt2box";
        
        this.addNumberPad(); 
        boxb = this.add.sprite(593,120,'Level42C_boxb');
        boxb.height+=20;
        boxb.visible=false;
    ...
    addNumberPad:function(){
        ...
        counterText = this.add.text(35,35,selectedAns1="");
        ...
        counterText1 = this.add.text(35,35,selectedAns2="");
        ...
        wrongbtn = numGroup.create(x+50,505,'Level42C_eraser','Symbol 14 copy 5 instance 10000');
        wrongbtn.scale.setTo(0.95,0.98);
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+100,506,'Level42C_rightBtn','Symbol 14 copy instance 10000');
        rightbtn.anchor.setTo(0.5);
        rightbtn.scale.setTo(0.95,1);
            ...
            if(selectedAns2.length<2)
            {
               ...
               /* if(wrongflag==1){
                ...
                if(questarrayC[qnoC-1]==1){
                    ...
                    boxb.visible=false;
                    vessel1c.frameName="<Group>_73 copy 2 instance 10000";
                }
                    ...
                    boxb.visible=false;
                    bluecanc.frameName="<Group>_51 copy 2 instance 10001";
                }
            ...
            if(selectedAns2.length==2){
               /* if(wrongflag==1){
                ...
                if(questarrayC[qnoC-1]==5){
                    ...
                    boxb.visible=false;
                    bluebucketc.frameName="<Group>_15 copy 2 instance 10001";
                }
            }
    ...
    triggerevent:function(target){
                ...
                if(orangemugcincr>6)
                ...
                else
                    {
                        ...
                        else if(orangemugcincr<6)
                        {
                            //less than 2
                            _this.waterFillingSound.play(); 
                            vessel1c.frameName="<Group>_73 copy 2 instance 1000"+(orangemugcincr);
                        }
        ...
        if(target.name=="sodac")
            {
                vessel1c.destroy();
                vessel1c = this.add.sprite(607,201,'Level42C_cooker2','<Group>_73 copy instance 10000');
                vessel1canim=vessel1c.animations.add('vessel1c');
                _this.clickSound.play();
                sodacincr++;
                if(sodacincr>10)
                ...
                else
                    {
                        ...
                        {
                            _this.waterFillingSound.play();
                            vessel1c.frameName="<Group>_73 copy instance 1000"+(sodacincr);
                        }
            ...
            if(target.name=="pinkbucketc")
            {
                _this.clickSound.play();
                bluecanc.destroy();
                bluecanc = this.add.sprite(621,140,'Level42C_can2','<Group>_51 copy instance 10001');
                bluecancanim=bluecanc.animations.add('bluecanc');
                pinkbucketcincr++;
                if(pinkbucketcincr>15)
                ...
                else
                    {
                        ...
                        {
                            boxclick="opt1box";
                            this.enablebuttons(15,5,'pinkbucketc');
                            _this.waterFillingSound.stop();
                            _this.watersplash.play();
                            box1.alpha=1;
                            box2.alpha=1;
                ...
                if(greenbottlecincr>5)
                ...
                else
                    {
                        ...
                        else if(greenbottlecincr<5)
                        {
                            //less than 5
                            _this.waterFillingSound.play(); 
                            bluecanc.frameName="<Group>_51 copy 2 instance 1000"+(greenbottlecincr+1);
                        }
                    }
            }
            ...
            if(target.name=="redjugc")
            {
                _this.clickSound.play();
                bluebucketc.destroy();
                bluebucketc = this.add.sprite(601,160,'Level42C_bluebucketc1','<Group>_15 copy instance 10001');
                bluebucketc.width-=70;
                bluebucketc.height-=70;
                bluebucketcanim=bluebucketc.animations.add('bluebucketc');
                redjugcincr++;
                if(redjugcincr>10)
                ...
                else
                    {
                        ...
                        {
                            boxclick="opt1box";
                            this.enablebuttons(10,15,'redjugc');
                            _this.waterFillingSound.stop();
                            _this.watersplash.play();
                            box1.alpha=1;
                            box2.alpha=1;
                        ...
                        else//less than 10
                        {
                            _this.waterFillingSound.play();
                            if(redjugcincr<9)
                            bluebucketc.frameName="<Group>_15 copy instance 1000"+(redjugcincr+1);
                            else
                ...
                if(nipplecincr>15)
                ...
                else
                    {
                        ...
                        else if(nipplecincr<15)
                        {
                            ...
                            _this.waterFillingSound.play(); 
                            if(nipplecincr<9)
                                bluebucketc.frameName="<Group>_15 copy 2 instance 1000"+(nipplecincr+1);
                            else
            ...
            if(target.name=="glass")
            {
                _this.clickSound.play();
                greenmugc.destroy();
                greenmugc = this.add.sprite(612,113,'Level42C_greenmugc2','<Group>_57 copy instance 10000');
                greenmugcanim=greenmugc.animations.add('greenmugc');
                greenmugc.width+=70;
                greenmugc.height+=95;
                glassincr++;
                ...
                if(yellowctcincr>9)
                ...
                else
                    {
                        ...
                        else if(yellowctcincr<9)
                        {
                            //less than 9
                            _this.waterFillingSound.play(); 
                            greenmugc.frameName="<Group>_57 copy 2 instance 1000"+(yellowctcincr+1);
                        }
                    }
            }
            ...
            if(target.name=="greencupc")
            {
                _this.clickSound.play();
                vessel2c.destroy();
                vessel2c = this.add.sprite(585,90,'Level42C_vessel2','<Group>_73 copy instance 10001');
                vessel2canim=vessel2c.animations.add('vessel2c');
                vessel2c.height+=150;
                greencupcincr++;
                if(greencupcincr>7)
            ...
            if(target.name=="greencupreverse")
            {
                _this.clickSound.play();
                bluepotc.destroy();
                bluepotc = this.add.sprite(613,110,'Level42C_potsplash2','<Group>_90 copy instance 10001');
                bluepotcanim=bluepotc.animations.add('bluepotc');
                bluepotc.width-=20;
                bluepotc.height-=50;
                greencupreverseincr++;
