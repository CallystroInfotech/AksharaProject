...
//timer.setText(minutes + ':'+ seconds );
  ...
  _this.timer1.start();
        ...
        //console.log("get"+no1);
		//no1 = 8;
		_this.questionid = "4.3A1#SCR-"+_this.sceneCount;
    	switch(qArrays[no1])      
    	{
...
displayEquation:function()
    {
        ...
        this.addNumberPad();*/
		 ...
		 if(window.languageSelected=="English"){
            kgTxt = this.add.text(540,300, "ml");
            kgTxt1 = this.add.text(780,300, "ml");
			kgTxt.font = 'myfont';
			kgTxt1.font = 'myfont';
			...
			kgTxt1.fontSize = 25;
				...
				kgTxt = this.add.text(535,305, "मि.ली ");
				kgTxt1 = this.add.text(785,305, "मि.ली ");
				...
				kgTxt = this.add.text(534,305, "ಮಿ.ಲೀ");
				kgTxt1 = this.add.text(795,305, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt1.font = 'Comic Sans MS';
				kgTxt.fontSize = 19;
				kgTxt1.fontSize = 19;
    ...
    addNumberPad:function(){
        ...
        var txtbox = this.add.sprite(720,300,'Level43A_AnswerBox');
        ...
        var rightbtn = numGroup.create(x+70,505,'tick');
