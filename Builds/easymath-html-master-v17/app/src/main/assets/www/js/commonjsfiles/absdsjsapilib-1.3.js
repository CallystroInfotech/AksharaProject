...
var absdsjsapi = {
    ...
    initializeDS: function () {
        ...
        if (this.debugalerts)
            console.log("Enter initialiseDS");
        ...
        this.absdbhandler = window.sqlitePlugin.openDatabase(
            ...
            function () {
                if (this.debugalerts)
                    console.log("initialiseDS: openDatabase success");
            },
            function (msg) {
                if (this.erroralerts)
                    console.log("initialiseDS: openDatabase failed: " + msg);
                return false;
            }
        );
    ...
    deleteDS: function () {
        ...
        this.absdbhandler = window.sqlitePlugin.deleteDatabase(
            ...
            function () {
                if (this.debugalerts)
                    console.log("deleteDS: success");
            },
            function (msg) {
                if (this.erroralerts)
                    console.log("deleteDS: failed: " + msg);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteDS");
    },
    ...
    createTables: function () {
        ...
        if (this.debugalerts)
            console.log("Enter createTables");
        ...
        this.absdbhandler.sqlBatch([
            ...
            function (error) {
                if (this.erroralerts)
                    console.log("createTables: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit createTables");
    ...
    dropTables: function () {
        ...
        this.absdbhandler.sqlBatch([
            ...
            function () {
                if (this.debugalerts)
                    console.log("dropTables: success");
            },
            function (error) {
                if (this.erroralerts)
                    console.log("dropTables: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit dropTables");
    ...
    saveGameplay: function (objData) {
        ...
        if (this.debugalerts)
            console.log("Enter saveGameplay. objData: " + objData.id_game+", "+objData.access_token+", "+objData.start_time);
        ...
        this.absdbhandler.executeSql(query, [gameplayid, objData.id_game, objData.access_token, objData.start_time],
            function (rs) {
                if (this.debugalerts) {
                    console.log("saveGameplay: success. id_game_play: " + gameplayid);
                    console.log("resultSet.insertId: " + rs.insertId);
                    console.log("resultSet.rowsAffected: " + rs.rowsAffected);
                }
            ...
            function (error) {
                if (this.erroralerts)
                    console.log("saveGameplay: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit saveGameplay");
        return gameplayid;
    },
    ...
    fetchUnsyncedGameplayRecords: function (callbackfn) {
        ...
        if (this.debugalerts)
            console.log("Enter fetchUnsyncedGameplayRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                ...
                if (this.debugalerts)
                   console.log("fetchUnsyncedGameplayRecords: success. Number of records:"+nrecords);
                
                for (var i = 0; i < nrecords; i++) {
                    arrObjs.push(rs.rows.item(i));
                }
                if (this.debugalerts)
                    console.log("fetchUnsyncedGameplayRecords: arrObjs: " + JSON.stringify(arrObjs));

                callbackfn(arrObjs); // Invoke the callback function to send the array of Objects with the fetched records
            },
            function (error) {
                if (this.erroralerts)
                    console.log("fetchUnsyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit fetchUnsyncedGameplayRecords");
    ...
    fetchUnsyncedGameplayRecords_cbf: function (arrRecords) {
        ...
        if(this.debugalerts)
            console.log("Enter fetchUnsyncedGameplayRecords_cbf");
    ...
    markSyncedGameplayRecords: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter markSyncedGameplayRecords. ids:" + ids + "  query: "+query);

        if ((ids.length == 0) || (ids == '')) {
            if (this.debugalerts)
                console.log("Empty list of 'id's. No action performed.");
            return true;
        }
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts) 
                    console.log("markSyncedGameplayRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts) 
                    console.log("markSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts) 
            console.log("Exit markSyncedGameplayRecords");
    },
    ...
    deleteSyncedGameplayRecords: function () {
        ...
        if (this.debugalerts) 
            console.log("Enter deleteSyncedGameplayRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts) 
                    console.log("deleteSyncedGameplayRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteSyncedGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts) 
            console.log("Exit deleteSyncedGameplayRecords");
    },
    ...
    deleteGameplayRecordsByIds: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter deleteGameplayRecordsByIds");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteGameplayRecordsByIds: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteGameplayRecordsByIds: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteGameplayRecordsByIds");
    },
    ...
    deleteAllGameplayRecords: function () {
        ...
        if (this.debugalerts)
            console.log("Enter deleteAllGameplayRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteAllGameplayRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteAllGameplayRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteAllGameplayRecords");
    },
    ...
    saveAssessment: function (objData) {
        ...
        if (this.debugalerts)
            console.log("Enter saveAssessment. objData: " + objData.id_game_play + ", " + objData.id_question + ", " + objData.pass + ", " + objData.time2answer + ", " + objData.attempts + ", " + objData.date_time_submission + ", " + objData.access_token);
        ...
        this.absdbhandler.executeSql(query, [objData.id_game_play, objData.id_question, objData.pass, objData.time2answer, objData.attempts, objData.date_time_submission, objData.access_token],
            ...
            function (error) {
                if (this.erroralerts)
                    console.log("saveAssessment: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit saveAssessment");
    },
    ...
    fetchUnsyncedAssessmentRecords: function (callbackfn) {
        ...
        if (this.debugalerts)
            console.log("Enter fetchUnsyncedAssessmentRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (this.debugalerts)
                    console.log("fetchUnsyncedAssessmentRecords: success. Number of records:" + nrecords);
            ...
            function (error) {
                if (this.erroralerts)
                    console.log("fetchUnsyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit fetchUnsyncedAssessmentRecords");
    ...
    fetchUnsyncedAssessmentRecords_cbf: function (arrRecords) {
        ...
        if (this.debugalerts)
            console.log("Enter fetchUnsyncedAssessmentRecords_cbf");
    ...
    markSyncedAssessmentRecords: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter markSyncedAssessmentRecords. ids:" + ids + "  query: " + query);
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("markSyncedAssessmentRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("markSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit markSyncedAssessmentRecords");
    },
    ...
    deleteSyncedAssessmentRecords: function () {
        ...
        if (this.debugalerts)
            console.log("Enter deleteSyncedAssessmentRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteSyncedAssessmentRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteSyncedAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteSyncedAssessmentRecords");
    },
    ...
    deleteAssessmentRecordsByIds: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter deleteAssessmentRecordsByIds");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteAssessmentRecordsByIds: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteAssessmentRecordsByIds: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteAssessmentRecordsByIds");
    },
    ...
    deleteAllAssessmentRecords: function () {
        ...
        if (this.debugalerts)
            console.log("Enter deleteAllAssessmentRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteAllAssessmentRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteAllAssessmentRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteAllAssessmentRecords");
    },
    ...
    saveInteractEvent: function (objData) {
        ...
        if (this.debugalerts)
            console.log("Enter saveInteractEvent. objData: " + objData.id_game_play + ", " + objData.id_question + ", " + objData.date_time_event + ", " + objData.event_type + ", " + objData.res_id + ", "+ objData.access_token);
        ...
        this.absdbhandler.executeSql(query, [objData.id_game_play, objData.id_question, objData.date_time_event, objData.event_type, objData.res_id, objData.access_token],
            function (rs) {
                if (this.debugalerts) 
                    console.log("saveInteractEvent: success");
            },
            function (error) {
                if (this.erroralerts)
                    console.log("saveInteractEvent: failed" + error.message);
            }
        );

        if (this.debugalerts)
            console.log("Exit saveInteractEvent");
    },
    ...
    fetchUnsyncedInteractEventRecords: function (callbackfn) {
        ...
        if (this.debugalerts)
            console.log("Enter fetchUnsyncedInteractEventRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                var nrecords = rs.rows.length;
                if (this.debugalerts)
                    console.log("fetchUnsyncedInteractEventRecords: success. Number of records:" + nrecords);
            ...
            function (error) {
                if (this.erroralerts)
                    console.log("fetchUnsyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit fetchUnsyncedInteractEventRecords");
    ...
    fetchUnsyncedInteractEventRecords_cbf: function (arrRecords) {
        ...
        if (this.debugalerts)
            console.log("Enter fetchUnsyncedInteractEventRecords_cbf");
    ...
    markSyncedInteractEventRecords: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter markSyncedInteractEventRecords. ids:" + ids + "  query: " + query);
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("markSyncedInteractEventRecords: success. resultSet.rowsAffected:" + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("markSyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit markSyncedInteractEventRecords");
    },
    ...
    deleteSyncedInteractEventRecords: function () {
        ...
        if (this.debugalerts)
            console.log("Enter deleteSyncedInteractEventRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteSyncedInteractEventRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteSyncedInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteSyncedInteractEventRecords");
    },
    ...
    deleteInteractEventRecordsByIds: function (ids) {
        ...
        if (this.debugalerts)
            console.log("Enter deleteInteractEventRecordsByIds");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteInteractEventRecordsByIds: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteInteractEventRecordsByIds: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteInteractEventRecordsByIds");
    },
    ...
    deleteAllInteractEventRecords: function () {
        ...
        if (this.debugalerts)
            console.log("Enter deleteAllInteractEventRecords");
        ...
        this.absdbhandler.executeSql(query, [],
            function (rs) {
                if (this.debugalerts)
                    console.log("deleteAllInteractEventRecords: success. resultSet.rowsAffected: " + rs.rowsAffected);
            },
            function (error) {
                if (this.erroralerts)
                    console.log("deleteAllInteractEventRecords: failed" + error.message);
                return false;
            }
        );

        if (this.debugalerts)
            console.log("Exit deleteAllInteractEventRecords");
    },
...
var RESTAPImgr = {
    ...
    absrestapi_baseurl: "http://www.kodvin.com/abs/",
    ...
    invokeRESTAPI: function (apiname, jsondata) {
        ...
        $.ajax({
            ...
            error: function (error) {
                rtn = false;
                console.log("invokeRESTAPI failed: api: "+apiurl+" error: "+error.toString());
            }
        });
...
var TestMgr_absdsjsapi = {
    ...
    doTest: function (arg) {
        ...
        switch (arg) {
            ...
            case '4':
                var gameplaydata = { id_game: "100", access_token: accesstoken, start_time: "12:10:05:25:15:10" };
