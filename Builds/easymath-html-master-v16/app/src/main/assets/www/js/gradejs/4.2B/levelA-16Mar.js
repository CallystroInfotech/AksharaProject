...
init:function(game)
	...
	_this.backbtn = _this.add.sprite(10,7,'Level42A_CommonBackBtn');
       ...
       _this.speakerbtn = _this.add.sprite(620,9,'Level42A_CommonSpeakerBtn');
    ...
    var timebg=this.add.sprite(270,9,'Level42B_timer');
    ...
    addQuestion:function(no2)
    {
     ...
     gotoFirstQuestion:function(){
         var red1 = this.add.sprite(237,200,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(470,240,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(690,280,'Level42B_redmark');
         ...
         var sh1=this.add.sprite(155,397,'Level42B_shadow7');
         sh1.alpha=0.5;
         ...
         box2=this.add.sprite(120,410,'Level42B_box');
         box2.scale.setTo(0.85,0.65);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(385,410,'Level42B_box');
         box1.scale.setTo(0.85,0.65);
         box1.alpha=0;
         box1.name="opt2box";
         
         box=this.add.sprite(635,410,'Level42B_box');
         box.scale.setTo(0.85,0.65);
         box.alpha=0; 
         box.name="opt1box";
         ...
         a1=this.add.sprite(795,95,'Level42B_a11','<Group>_373 instance 10000');
         if(no1==1)
         {
            this.getVoice(no1);
    ...
    gotoSecondQuestion:function(){
         ...
         var red1 = this.add.sprite(237,250,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(425,215,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(710,215,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
        ...
        sh3.alpha=0.5;
         ...
         box2=this.add.sprite(124,410,'Level42B_box');
         box2.scale.setTo(0.85,0.65);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(383,410,'Level42B_box');
         box1.scale.setTo(0.85,0.65);
         box1.alpha=0;
         box1.name="opt2box";
         
         box=this.add.sprite(637,410,'Level42B_box');
         box.scale.setTo(0.85,0.65);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
      ...
      gotoThirdQuestion:function(){
          var red1 = this.add.sprite(200,190,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(425,200,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(720,195,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	 no1++;
         i=1;
         j=1;
         ...
         box2=this.add.sprite(115,410,'Level42B_box');
         box2.scale.setTo(0.85,0.65);
         box2.alpha=0;
         box2.name="opt3box";
         ...
         opt1=this.add.sprite(180,445,'Level42B_mugB','<Group>_453 instance 10000');
         opt1.anchor.setTo(0.5,1);
         opt1.scale.setTo(0.8,0.8);
         opt1.name = "mugB";
         opt1.value = 16;

         opt2=this.add.sprite(430,420,'Level42B_orangebottleB','<Group>_452 copy 3 instance 10000');
         opt2.anchor.setTo(0.5,1);
         opt2.scale.setTo(0.9,1);
         opt2.name = "orangebottleB";
         opt2.value = 6;

         opt3=this.add.sprite(690,450,'Level42B_canB','<Group>_51 copy instance 10001');
         opt3.anchor.setTo(0.5,1);
         opt3.scale.setTo(0.8,0.9);
         opt3.name = "canB";
         opt3.value = 16;
         ...
         a1=this.add.sprite(790,95,'Level42B_a11','<Group>_373 instance 10000');
          if(no1==1)
         {
            this.getVoice(no1);
            this.time.events.add(1300,function(){
       ...
       gotoFourthQuestion:function(){
         var red1 = this.add.sprite(165,190,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(425,170,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(680,235,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	  no1++;
          i=1;
          j=1;
         ...
         box=this.add.sprite(638,410,'Level42B_box');
         box.scale.setTo(0.85,0.65);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
        ...
        opt3=this.add.sprite(690,464,'Level42B_bottle22','<Group>_74 copy 4 instance 10001');
         opt3.anchor.setTo(0.5,1);
     ...
     gotoFifthQuestion:function(){
         var red1 = this.add.sprite(190,245,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(495,240,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(680,270,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	no1++;
           i=1;
         j=1;
         ...
         sh1.anchor.setTo(0.5,1);
          sh1.scale.setTo(0.35,1);
           ...
           var sh2=this.add.sprite(410,360,'Level42B_shadow8');
         sh2.alpha=0.5;
         sh2.anchor.setTo(0.5,1);
         ...
         box1=this.add.sprite(400,410,'Level42B_box');
         box1.scale.setTo(0.85,0.65);
         box1.alpha=0;
         box1.name="opt2box";
         ...
         box.inputEnabled=true;
          ...
          opt1=this.add.sprite(170,415,'Level42B_pinkglass','<Group>_454 instance 10000');
         opt1.anchor.setTo(0.5,1);
         opt1.scale.setTo(1,1);
         opt1.name = "pinkglass";
         opt1.value = 16;

        opt2=this.add.sprite(440,470,'Level42B_greencup','<Group>_455 instance 10000');
         opt2.anchor.setTo(0.5,1);
         opt2.scale.setTo(0.9,1);
         opt2.name = "greencup";
        opt2.value = 21;

        opt3=this.add.sprite(670,372,'Level42B_smallbottle','Symbol 19 instance 10001');
         opt3.anchor.setTo(0.5,1);
         opt3.scale.setTo(0.9,1);
  ...
  wronggraphics3.alpha = 0;
    ...
    gotoSixthQuestion:function(){
        var red1 = this.add.sprite(180,235,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(475,190,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(705,285,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	no1++;
          i=1;
         j=1;
        ...
        sh1.alpha=0.5;
         sh1.anchor.setTo(0.5,1);
          sh1.scale.setTo(0.35,1);
           ...
           var sh2=this.add.sprite(420,383,'Level42B_shadow8');
        sh2.alpha=0.5;
         sh2.anchor.setTo(0.5,1);
          sh2.scale.setTo(1,1);
        ...
        sh3.alpha=0.5;
         ...
         box=this.add.sprite(628,410,'Level42B_box');
         box.scale.setTo(0.85,0.65);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
        ...
        opt3=this.add.sprite(683,470,'Level42B_bucket','<Group>_15 instance 10001');
         opt3.anchor.setTo(0.5,1);
         opt3.scale.setTo(0.9,1);
         opt3.name = "bucket33";
         opt3.value = 3;
     ...
     gotoSeventhQuestion:function(){
         var red1 = this.add.sprite(165,212,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(475,210,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(691,278,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	no1++;
           i=1;
         j=1;
         ...
         box=this.add.sprite(631,410,'Level42B_box');
         box.scale.setTo(0.85,0.65);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
         
          opt1=this.add.sprite(175,460,'Level42B_bottle44','<Group>_74 copy 5 instance 10000');
         opt1.anchor.setTo(0.5,1);
         opt1.scale.setTo(1,1);
         opt1.name = "bottle44";
         opt1.value = 4;

         opt2=this.add.sprite(430,425,'Level42B_redmug','<Group>_458 instance 10000');
         opt2.anchor.setTo(0.5,1);
         opt2.scale.setTo(0.9,1);
         opt2.name = "redmug";
        opt2.value = 6;
     ...
     wronggraphics2.alpha = 0;
      ...
      wronggraphics3.alpha = 0;
        ...
        wronggraphics3.input.useHandCursor = true;
         ...
         a1=this.add.sprite(800,95,'Level42B_a11','<Group>_373 instance 10000');
         if(no1==1)
         {
            this.getVoice(no1);
            this.time.events.add(1300,function(){
      ...
      gotoEighthQuestion:function(){
          var red1 = this.add.sprite(224,212,'Level42B_redmark');
         red1.scale.setTo(0.75,0.75);
         var red2 = this.add.sprite(455,263,'Level42B_redmark');
         red2.scale.setTo(0.75,0.75);
         var red3 = this.add.sprite(741,258,'Level42B_redmark');
         red3.scale.setTo(0.75,0.75);
    	no1++;
            i=1;
         j=1;
        ...
        boxb1=this.add.sprite(155,420,'Level42B_boxb');
         ...
         box2=this.add.sprite(122,410,'Level42B_box');
         box2.scale.setTo(0.85,0.65);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(391,410,'Level42B_box');
         box1.scale.setTo(0.85,0.65);
         box1.alpha=0;
         box1.name="opt2box";
  ...
  return array;
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			starsGroup.create(this.world.centerX, 10, 'Level42A_CommonStarAnim');
			for(var j =0;j<i;j++)
			{
...
//            starsGroup1.visible=false;
    ...
    addNumberPad:function(){
        ...
        counterText2 = this.add.text(35,35, selectedAns3="");
     ...
     //   txtbox.anchor.setTo(0.5);
      //  txtbox.name = "txtbox";
        ...
        wrongbtn = numGroup.create(x+50,502,'Level42B_eraser');
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.scale.setTo(0.5,0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+100,502,'Level42B_rightBtn');
