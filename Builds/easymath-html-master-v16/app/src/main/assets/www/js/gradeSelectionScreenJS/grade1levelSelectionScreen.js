...
Game.grade1levelSelectionScreen.prototype={
	...
	create:function(game){
		...
		_this.grade1additionQuantityGroup.y = 1450;

		_this.grade1numberBondsGroup.x = 0;
		_this.grade1numberBondsGroup.y = 1700;

		_this.SubtractionWithQuantityGroup.x = 0;
		_this.SubtractionWithQuantityGroup.y = 1950;

		_this.MultiplicationWithQuantityGroup.x = 0;
		_this.MultiplicationWithQuantityGroup.y = 2200;
	...
	QuantityNumeralTopic:function()
	{
		...
		_this.CountingFish1_3ScreenTxt = _this.add.sprite(575,250,'Counting fish');
		...
		_this.CountingFlowers1_4ScreenTxt = _this.add.sprite(775,250,'Counting flowers');
		...
		_this.PluckingMangoes1_5ScreenTxt = _this.add.sprite(175,450,'Plucking mangoes');
		...
		_this.BurstingBubbles1_6ScreenTxt = _this.add.sprite(375,450,'Bursting bubbles');
		...
		_this.TracingNumbers1_7ScreenTxt = _this.add.sprite(575,450,'Tracing numbers');
	...
	additionQuantityTopic:function()
	{
		...
		_this.hungryRabbit5_1ScreenTxt = _this.add.sprite(165,250,'Hungry Rabbit');
	...
	NumberBondsTopic:function()
	{
		...
		_this.hungryRabbit6_1ScreenTxt = _this.add.sprite(165,250,'Hungry Rabbit');
	...
	SubtractionWithQuantity:function()
	{
		...
		_this.hungryRabbit8_1ScreenTxt = _this.add.sprite(165,250,'Hungry Rabbit');
	...
	MultiplicationWithQuantity:function()
	{
		...
		_this.AforApple11_1ScreenTxt = _this.add.sprite(175,250,'A for Apple');
		...
		_this.AforApple11_2ScreenTxt = _this.add.sprite(375,250,'A for Apple');
