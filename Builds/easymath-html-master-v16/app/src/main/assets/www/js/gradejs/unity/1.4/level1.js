...
Game.unity1_4level1.prototype ={
	...
	create:function(game){
        ...
        _this.speakerbtn = _this.add.sprite(600,5,'unity1_4CommonSpeakerBtn');
        ...
        _this.timebg = this.add.sprite(300,5,'unity1_4timebg');
    ...
    getQuestion:function(target)
    {
       ...
       //_this.no11 = 8;
       _this.questionid = "Game1_4#SCR-"+_this.sceneCount;
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX, 15, 'unity1_4starAnim');
			for(var j =0;j<i;j++)
			{
