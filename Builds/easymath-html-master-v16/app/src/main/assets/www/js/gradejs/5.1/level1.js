...
Game.grade5_1level1.prototype={
	...
	create:function(game){
        ...
        _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level5.1_bg1');
       ...
       _this.backbtn = _this.add.sprite(5,1,'CommonBackBtn');
        ...
        if(window.selectedlanguage=="English")
            _this.timeadd=7000;
        else if(window.selectedlanguage=="हिंदी")
            _this.timeadd=5000;
        else
            _this.timeadd=6000;
       // no1++;
   ...
   // console.log("2 "+target.parent.frameName);   
    ...
    gotoFirstQuestion:function(){
        ...
        _this.questionid = "5.1_1#SCR-"+_this.sceneCount;
