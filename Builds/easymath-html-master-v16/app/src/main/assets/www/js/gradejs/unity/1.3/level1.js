...
Game.unity1_3level1.prototype={
	...
	create:function(game){
       ...
       _this.yArray = _this.shuffle(_this.yArray);
        ...
        _this.numbg = this.add.sprite(0,440,'unity13_numbg');
        _this.numbg.scale.setTo(1,1.5)
...
//timer.setText(minutes + ':'+ seconds );
 ...
 gotoFirstQuestion:function(){
      //this.stopVoice();
       _this.questionid = "Game1.3_1#SCR-"+_this.sceneCount;
    ...
    addNumberPad:function(){
        ...
        _this.someArray = [100,195,290,385,480,575,670,765,860];
        _this.someArray = _this.shuffle(_this.someArray);
        //objGroup = this.add.group();
        _this.x = 100;
        for(var i=0;i<9;i++)
        {
            _this.numbg = _this.numGroup.create(_this.someArray[i],490,'unity13_NumberKey');  
