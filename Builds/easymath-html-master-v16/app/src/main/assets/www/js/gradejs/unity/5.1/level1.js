...
init:function(game)
 {
  ...
  return array;
    ...
    _this.timer.start();
        ...
        dragcount = 0;
         this.questionid = "Game5_1#SCR-"+this.sceneCount;
    	switch(qArrays[no11])
       //switch(no11)
    	{
    		case 1: 
...
//      
       ...
       //////console.log("pressed=="+pressed);
            ...
            tick=this.add.sprite(860,410,'grade51_tick');
        tick.name="grade51_tick";
            tick.anchor.setTo(0.5);
            tick.scale.setTo(0.66,0.66);
            tick.frame=0;
            ...
            eraser=this.add.sprite(790,410,'grade51_eraser');
        eraser.name="grade51_eraser";
            eraser.anchor.setTo(0.5);
            eraser.scale.setTo(0.66,0.66);
            eraser.frame=0;
