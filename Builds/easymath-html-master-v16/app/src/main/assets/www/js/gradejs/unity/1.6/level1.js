...
Game.unity1_6level1.prototype={
	...
	create:function(game){
       ...
       // _this.baudio.play();
        ...
        _this.timebg = _this.add.sprite(300,5,'unity16_timebg');
        ...
        _this.backbtn = _this.add.sprite(5,1,'unity16_CommonBackBtn');
       ...
       _this.speakerbtn = _this.add.sprite(600,5,'unity16_CommonSpeakerBtn');
      // _this.speakerbtn.inputEnabled = true;
        ...
        if(window.languageSelected=="English")
            {
                 _this.src.setAttribute("src", "questionSounds/unity/1.6/English/Game 1.6.mp3");
            }
        else if(window.languageSelected=="Hindi")
            {
                _this.src.setAttribute("src", "questionSounds/unity/1.6/Hindi/Game 1.6.mp3");
            }
        else
            {
                _this.src.setAttribute("src", "questionSounds/unity/1.6/Kannada/Game 1.6.mp3");
            }
    ...
    getQuestion:function(target)
    {
    	...
    	{
    		case 1: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 1;
                    _this.opt = [1,6,3,8,7,5,11,15,16,14];
                    _this.addBubble();
    				break;
    		case 2: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 2;
                    _this.opt = [1,2,4,6,8,7,12,15,16,17];
                    _this.addBubble();
    				break;
    		case 3: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 3;
                    _this.opt = [3,13,16,14,7,6,4,19,5,9];
                    _this.addBubble();
    				break;
    		case 4: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 4;
                    _this.opt = [1,14,18,8,7,6,4,15,5,9];
                    _this.addBubble();
    				break;
    		case 5: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 5;
                    _this.opt = [13,1,10,8,7,6,4,15,5,12];
                    _this.addBubble();
    				break;
    		case 6: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 6;
                    _this.opt = [13,1,10,8,3,6,4,16,5,12];
                    _this.addBubble();
    				break;
    		case 7: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 7;
                    _this.opt = [13,1,10,8,7,6,4,15,5,14];
                    _this.addBubble();
    				break;
            case 8: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 8;
                    _this.opt = [18,1,10,8,3,9,4,16,5,14];
                    _this.addBubble();
    				break;
            case 9: _this.questionid = "Game1.6#SCR-"+_this.sceneCount;
                    _this.selectAns = 9;
...
numClicked:function(target){
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX, 15, 'unity16_starAnim');
			for(var j =0;j<i;j++)
			{
