...
gotoTwevelvethQuestion:function(){
 ...
 addNumberPad:function(target){
        ...
        _this.box1 = _this.numGroup.create(480,500,'unity11_1b2');
        _this.box1.anchor.setTo(0.5);
        _this.x = 80;
     
        for(var i=0;i<10;i++)
        {
            _this.numbg = _this.numGroup.create(_this.x,500,'unity11_1numberpad');  
        ...
        _this.wrongbtn = _this.numGroup.create(_this.x+30,500,'unity11_1erase');
        ...
        _this.rightbtn = _this.numGroup.create(_this.x+90,500,'unity11_1rightmark');
