...
Game.grade1_2Blevel1.prototype={
	create:function(game){
       ...
       speakerBtn = this.add.button(908,1,'CommonSpeakerBtn',function(){
		...
		//adding game assets.          
       /* var bottomLine = this.add.sprite(this.world.centerX,this.world.centerY,'Level12A_bottomLine');
		...
		scoretext = this.add.text(200, 530, selctedLang.score+' : '+score);
    ...
    flagmain11Anim = game.add.sprite(100, 100,'Level12A_scene1wind1','Symbol 29 copy 2 instance 10000');
  ...
  return array;
	...
	addFirstWindMill:function()
	{
        ...
        var stick = this.add.sprite(this.world.centerX-205,this.world.centerY+40,'Level12A_stick');
...
//		windAnim1.animations.add('rotate');
        ...
        windAnim1 = this.add.sprite(this.world.centerX-200,this.world.centerY,'Level12A_scene2wind1');
    	windAnim1.anchor.setTo(0.5);
       // windAnim1.scale.setTo(0.9);
		//windAnim1.animations.add('rotate');
        //windAnim1.addChild(centerCircle);
...
//		windAnim1.animations.add('rotate');
        ...
        windAnim1 = this.add.sprite(this.world.centerX-200,this.world.centerY,'Level12A_scene2wind2');
    	windAnim1.anchor.setTo(0.5);
...
//		windAnim1.animations.add('rotate');
        ...
        windAnim1 = this.add.sprite(this.world.centerX-200,this.world.centerY,'Level12A_scene2wind3');
    	windAnim1.anchor.setTo(0.5);
