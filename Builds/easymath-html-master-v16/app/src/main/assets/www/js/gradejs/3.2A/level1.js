...
Game.grade3_2Alevel1.prototype={
	...
	create:function(game){   
       ...
       _this.qArrays = [];
        ...
        _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level32A_gameBg');
    ...
    getVoice:function(){
       _this.stopVoice();   
        ...
        switch(_this.qArrays[_this.count])
        {
            ...
            case 27:
            case 56:
                    _this.questionid = "3.2A1#SCR-"+_this.sceneCount;
            ...
            case 75:
            case 18:
                    _this.questionid = "3.2A2#SCR-"+_this.sceneCount;
                    if(window.languageSelected == "English")
                    {
