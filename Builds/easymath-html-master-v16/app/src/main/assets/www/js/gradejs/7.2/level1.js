...
Game.grade7_2level1.prototype={
	...
	create:function(game){
       ...
       // _this.qArrays = [1,3,5,7,9,11];
        ...
        _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level72_bg1');
        _this.bg2 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level72_bg2');
      ...
      // _this.speakerbtn.inputEnabled = true;baudio
        ...
        _this.graphics = this.add.graphics(0, 400baudio		_this.graphics.lineStyle(1, 0xFFFFFF, 0.8);
            ...
            if(_this.selectedAns==_this.rightAns||_this.selectedAns==_this.rightAns1||_this.selectedAns==_this.rightAns2||_this.selectedAns==_this.rightAns3||_this.selectedAns==_this.rightAns4)  
                {
                    ...
                    _this.noofAttempts++;
                      ...
                      _this.chime = _this.add.audio('click');
                    _this.chime.play();
...
//            MaintweenDestroy1.to({ x: 160}, 0, 'Linear', true, 0);
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(this.world.centerX-15, 10, 'CommonStarAnim');
    ...
    wrongAns:function(target)
	{
       ...
       // ////console.log(target);
		...
		_this.wmusic.play();
         ...
         _this.speakerbtn.inputEnabled=true;
         _this.speakerbtn.input.useHandCursor=true;
         _this.time.events.add(1000, function(){_this.crocsGroup.destroy();_this.objGroup.destroy();_this.shakeObjectGroup.destroy();_this.getQuestion();},_this);
        /* _this.b3.anchor.setTo(0.95, 0.5);
         _this.b3.angle = 90;
         _this.b5.anchor.setTo(0.5, 0.5);
         _this.b5.alpha = 100;
