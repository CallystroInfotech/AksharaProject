...
Game.grade3_3B2level1.prototype={
	...
	create:function(game){
     ...
     q1Array[0]=[1,4,7,10,13,16,19,22,25];
        ...
        bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'Level33B2_bg1');
  ...
  return array;
    ...
    {      
        ...
        _this.questionid = "3.3B_2#SCR-"+_this.sceneCount;
    ...
    checkOverlap:function(spriteA, spriteB) 
	{
     ...
     addNumberPad:function(){
        ...
        for(var i=0;i<10;i++)
        {
            var numbg = numGroup.create(x,500,'Level33B2_numbg');  
        ...
        var txtbox = this.add.sprite(x+10,500,'Level33B2_box-new');
        txtbox.anchor.setTo(0.5);
        txtbox.name = "txtbox";
         
        if(window.languageSelected=="English")
            kgTxt = this.add.text(x+80,500, "Kgs");
        ...
        var txtbox2 = this.add.sprite(x+150,500,'Level33B2_box-new');
        txtbox2.anchor.setTo(0.5);
        txtbox2.name = "txtbox2";
         
         if(window.languageSelected=="English")
                        var gmTxt = this.add.text(x+210,500, "Gms");
                    else if(window.languageSelected=="Hindi")
        ...
        var wrongbtn = numGroup.create(x+265,500,'Level33B2_wrongBtn');
        ...
        var rightbtn = numGroup.create(x+320,500,'Level33B2_rightBtn');
        ...
        enterTxt2.font = 'Alte Haas Grotesk';
        enterTxt2.fontSize = 24;
            //text.fontWeight = 'bold';
