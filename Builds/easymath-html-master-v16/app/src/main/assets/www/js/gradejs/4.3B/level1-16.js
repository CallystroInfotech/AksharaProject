...
//timer.setText(minutes + ':'+ seconds );
  ...
  _this.timer1.start();
		...
		_this.questionid = "4.3B1#SCR-"+_this.sceneCount;
    	switch(qArrays[no1])      
    	{
...
displayEquation:function()
    {
        ...
        this.addNumberPad();*/
         ...
         equation = this.add.sprite(645,323,'Level43A_equationB');
        ...
        // equation.frame = eqnum;
         ...
         this.addNumberPad();
		  ...
		  if(window.languageSelected=="English"){
            kgTxt = this.add.text(567,300, "ml");
            kgTxt1 = this.add.text(820,300, "ml");
			kgTxt.font = 'myfont';
			kgTxt1.font = 'myfont';
			...
			kgTxt1.fontSize = 25;
				...
				kgTxt = this.add.text(580,302, "मि.ली ");
				kgTxt1 = this.add.text(830,302, "मि.ली ");
				...
				kgTxt = this.add.text(579,302, "ಮಿ.ಲೀ");
				kgTxt1 = this.add.text(835,302, "ಮಿ.ಲೀ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt1.font = 'Comic Sans MS';
				kgTxt.fontSize = 19;
				kgTxt1.fontSize = 19;
