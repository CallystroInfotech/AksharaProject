...
public class Utils extends Activity {
    ...
    public static final String mainUrl = "https://abbmath.klp.org.in/abbchmprm/assets/assetsNew/";
    ...
    public static final long odiyaSize = 36484510;
    public static final long gujaratiSize = 28238786;
    public static final long assets1Size = 24716000;
    ...
    public static final File checkForSoundFileEnglish = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/questionSounds/1.1A/English"));

    public static final File checkForSoundFileHindi = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/questionSounds/1.1A/Hindi"));

    public static final File checkForSoundFileKannada = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/questionSounds/1.1A/Kannada"));

    public static final File checkForSoundFileOdiya = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/questionSounds/1.1A/Odiya"));

    public static final File checkForSoundFileGujarati = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/questionSounds/Gujarati"));

    public static final File checkForgameAssets1 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/commonAssets"));

    public static final File checkForgameAssets2 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/demoVideos"));

    public static final File checkForgameAssets3 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/gradeAssets/1.1A"));

    public static final File checkForgameAssets4 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/gradeAssets/2.2"));

    public static final File checkForgameAssets5 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/gradeAssets/4.1"));

    public static final File checkForgameAssets6 = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/assets/gradeAssets/6.1"));

    public static final File checkForgameJson = new File((Environment.getExternalStorageDirectory() +
            "/Android/data/com.akshara.easymathG/Files/Download/" + Utils.downloadDirectory +"/www/json"));
