...
Game.selectgrade3MicroConceptScreen.prototype={
	...
	create:function(game){		
		...
		else
		{
			...
			this.microConceptTopics(game,180,250,window.selctedLang.McTopicText1,"NUMBER SENSE","tree1",0);
			this.microConceptTopics(game,480,250,window.selctedLang.McTopicText2,"NUMBER OPERATIONS","tree2",1);
			this.microConceptTopics(game,780,250,window.selctedLang.McTopicText5,"MEASUREMENT","tree3",2);
