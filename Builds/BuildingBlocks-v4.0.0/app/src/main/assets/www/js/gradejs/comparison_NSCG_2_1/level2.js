...
getboyToUp:function()
    ...
    gotoFirstQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=5;
		 _this.numBox21.value=3;
		  _this.numBox31.value=1;
		  _this.numBox41.value=2;
		   _this.numBox51.value=4;

        _this.rightorder=[5,4,3,2,1];
    ...
    gotoSecondQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=9;
		 _this.numBox21.value=7;
		  _this.numBox31.value=5;
		  _this.numBox41.value=6;
		   _this.numBox51.value=8;

        _this.boxBlink();
        _this.rightorder=[9,8,7,6,5];//9,7,5,6,8
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoThirdQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=14;
		 _this.numBox21.value=12;
        ...
        //_this.UnorderedNum1.add(_this.numBox11);
        _this.boxBlink();
        _this.rightorder=[14,13,12,11,10];//14,12,10,11,13
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoFourthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=19;
		 _this.numBox21.value=17;
		  _this.numBox31.value=15;
		  _this.numBox41.value=16;
		   _this.numBox51.value=18;
        _this.rightorder=[19,18,17,16,15];//19,17,15,16,18
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=7;
		 _this.numBox21.value=5;
		  _this.numBox31.value=3;
		  _this.numBox41.value=4;
		   _this.numBox51.value=6;
        _this.rightorder=[7,6,5,4,3];//7,5,3,4,6
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoSixthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=11;
		 _this.numBox21.value=9;
		  _this.numBox31.value=7;
		  _this.numBox41.value=8;
		   _this.numBox51.value=10;
        _this.rightorder=[11,10,9,8,7];//11,9,7,8,10
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoSeventhQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=13;
		 _this.numBox21.value=11;
		  _this.numBox31.value=9;
		  _this.numBox41.value=10;
		   _this.numBox51.value=12;
        _this.rightorder=[13,12,11,10,9];//13,11,9,10,12
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=16;
		 _this.numBox21.value=14;
		  ...
		  _this.numBox41.value=13;
		   _this.numBox51.value=15;

        _this.rightorder=[16,15,14,13,12];//16,14,12,13,15
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=18;
		 _this.numBox21.value=16;
		  _this.numBox31.value=14;
		  _this.numBox41.value=15;
		   _this.numBox51.value=17;

        _this.rightorder=[18,17,16,15,14];//18,16,14,15,17
    ...
    gotoTenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=20;
		 _this.numBox21.value=18;
		  _this.numBox31.value=16;
		  _this.numBox41.value=17;
		   _this.numBox51.value=19;
        _this.rightorder=[20,19,18,17,16];//20,18,16,17,19
        ...
        _this.number3 = _this.add.text(16,-7.5,'16');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
    ...
    gotoEleventhQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=8;
		 _this.numBox21.value=6;
		  _this.numBox31.value=4;
		  _this.numBox41.value=5;
		   _this.numBox51.value=7;

        _this.rightorder=[8,7,6,5,4];//8,6,4,5,7
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		...
		_this.numBox11.value=17;
		 _this.numBox21.value=15;
		  ...
		  _this.numBox41.value=14;
		   _this.numBox51.value=16;

        _this.rightorder=[17,16,15,14,13];//17,15,13,14,16
    ...
    gotoThirteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
        ...
        _this.rightorder=[12,11,10,9,8];//12,10,8,9,11
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoFourteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
        ...
        _this.rightorder=[10,9,8,7,6];//10,8,6,7,9
    ...
    gotoFifteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=6;
		 _this.numBox21.value=4;
		  _this.numBox31.value=2;
		  _this.numBox41.value=3;
		   _this.numBox51.value=5;

        _this.rightorder=[6,5,4,3,2];//6,4,2,3,5
