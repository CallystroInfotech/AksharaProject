    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.1/English/46.2E.mp3");
                    }
                    else if(window.languageSelected=="hindi")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.1/Hindi/46.2H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", "questionSounds/4.6.1/Kannada/46.2K.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/4.6.1/Odiya/46.20.mp3");
