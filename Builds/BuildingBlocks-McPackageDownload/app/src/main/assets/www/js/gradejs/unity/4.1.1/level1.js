    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            case 1: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/English/lessobject.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Hindi/lessobjecthindi.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Kannada/4.2.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Odiya/4.1.1_a.mp3");
                    }
                    break;
                
            case 2: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/English/moreobject.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Hindi/moreobjecthindi.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Kannada/moreobjectkannda.mp3");
                    }
                   else
                  {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Odiya/4.1.1_b.mp3");
                    }
                    break;
            ...
            case 7:if(window.languageSelected=="English")
                    ...
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Kannada/lessobjectkannda.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src","questionSounds/4.1.1/Odiya/4.1.1_a.mp3");
