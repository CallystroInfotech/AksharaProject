...
//        scoretext.setText(selctedLang.score+' : '+score);
    ...
    {   
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3B/English/1.1A2.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3B/Hindi/1.1A2.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3B/Kannada/1.1A2.mp3");
        }
		else
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3B/Odiya/1.1A2.mp3");
