...
create:function(game)
    {
        ...
        _this.timerbg=_this.add.sprite(305,6,'unity2_6_3_timerbg');
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.3/English/26.3E.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.3/Hindi/26.3H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.3/Kannada/26.3K.mp3");
                    }
					else
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.3/Odiya/2.6.3.mp3");
