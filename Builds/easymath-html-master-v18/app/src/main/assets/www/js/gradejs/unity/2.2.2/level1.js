...
Game.unity2_2_2level1.prototype ={
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_2_start', 30, true);
           ...
           if (_this.Caterpillar_head.key == 'unity2_2_2_start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_2_2Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_2_start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_2_2wrong',null,true);
            }
