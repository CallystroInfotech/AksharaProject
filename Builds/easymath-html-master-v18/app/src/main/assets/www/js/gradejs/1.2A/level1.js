...
Game.grade1_2Alevel1.prototype={
  ...
  return array;
      ...
      //  windmillGroup.add(stick);
       ...
       // windmillGroup.add(centerCircle);
        ...
        var tween = this.add.tween(windmillGroup);
            ...
            tween.onComplete.add(function(){
                this.getVoice();
               // this.time.events.add(3100,function(){
            ...
            tween.onComplete.add(function(){
               ...
               // this.time.events.add(3100,function(){
                    ...
                    wronggraphics3.events.onInputDown.add(function(target){
                     windAnim1.loadTexture('scene1wind33', 0, false);
    ...
    addFourthWindMill:function()
	{
		count++;
		//adding windmill to the game.
        //var stick = this.add.sprite(this.world.centerX-5,this.world.centerY+60,'Level12A_stick');
		//stick.scale.setTo(1,1.2);
        
		windAnim1 = this.add.sprite(this.world.centerX,this.world.centerY+10,'Level12A_scene2wind1');		
    ...
    addFifthWindMill:function()
	{
		count++;		
		//adding windmill to the game.
       // var stick = this.add.sprite(this.world.centerX-3,this.world.centerY+60,'Level12A_stick');
		//stick.scale.setTo(1,1.2);
        
		windAnim1 = this.add.sprite(this.world.centerX,this.world.centerY+10,'Level12A_scene2wind2');		
		//windAnim1.scale.setTo(0.8);
		windAnim1.anchor.setTo(0.5,0.4);			
		//windAnim1.animations.add('rotate');
    ...
    addSixthWindMill:function()
	{
       ...
       // var stick = this.add.sprite(this.world.centerX-3,this.world.centerY+60,'Level12A_stick');
		...
		windAnim1 = this.add.sprite(this.world.centerX,this.world.centerY+10,'Level12A_scene2wind3');		
		//windAnim1.scale.setTo(0.8);
		windAnim1.anchor.setTo(0.5,0.4);				
		//windAnim1.animations.add('rotate');
