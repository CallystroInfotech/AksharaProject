...
Game.unity4_1_1level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.timeDisplay = _this.add.text(332,25,_this.minutes + ' : '+ _this.seconds);
     ...
     /* if(window.languageSelected=="English")
        {
            _this.src.setAttribute("src", "questionSounds/4.1/English/4.1G.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", "questionSounds/4.1/Hindi/4.1G.mp3");
        }
        else
        {
            _this.src.setAttribute("src", "questionSounds/4.1/Kannada/4.1G.mp3");
        }
    ...
    {  
        ...
        _this.optionGrp.add(_this.tick2);
	...
	correctAns:function(target)
	{
        ...
        {
            _this.tick1.frame = 1;
            _this.tick2.inputEnabled = false;
        }
    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
           ...
           case 8:if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", "questionSounds/4.1/English/4.1L.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", "questionSounds/4.1/Hindi/4.1L.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/4.1/Kannada/4.1L.mp3");
                    }
