...
init:function(game)
	...
	create:function(game){
        ...
        var timebg=this.add.sprite(270,9,'Level42A_timer');
    ...
    getQuestion:function()
	{
		...
		_this.questionid = "4.2A1#SCR-"+_this.sceneCount;
        grpnum=new Array();
    ...
    question1:function()
    {
        ...
        this.addNumberPad();
        var redmark=this.add.sprite(445,193,'Level42A_redmark');
    ...
    question2:function()
    {
        ...
        this.addNumberPad();
        var redmark=this.add.sprite(468,195,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
        questgroupA=this.add.group();
    ...
    question3:function()
    {
        ...
        this.addNumberPad();
        var redmark=this.add.sprite(498,270,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
        questgroupA=this.add.group();
    ...
    question4:function()
    {
        ...
        var redmark=this.add.sprite(453,156,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
        questgroupA=this.add.group();
    ...
    question5:function()
    {
        ...
        var redmark=this.add.sprite(378,205,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
    ...
    question6:function()
    {
        ...
        var redmark=this.add.sprite(450,170,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
    ...
    question7:function()
    {
        ...
        var redmark=this.add.sprite(475,113,'Level42A_redmark');
        redmark.scale.setTo(0.75,0.75);
        questgroupA=this.add.group();
    ...
    addNumberPad:function(){
        ...
        txtbox = this.add.sprite(x+50,505,'Level42A_box');
        txtbox.anchor.setTo(0.5);
        txtbox.name = "txtbox";
        
        wrongbtn = numGroup.create(x+120,502,'Level42A_eraser');
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.scale.setTo(0.5,0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+170,502,'Level42A_rightBtn');
    ...
    enablebuttons:function(target,rightAns){
        ...
        wrongbtn.events.onInputDown.add(function(){_this.clickSound.play();enterTxt.setText("");selectedAns="";},this);
