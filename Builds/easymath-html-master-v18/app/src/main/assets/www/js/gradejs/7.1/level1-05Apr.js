...
Game.grade7_1level1.prototype={
	...
	create:function(game){
     ...
     _this.randomgrp;
       ...
       _this.qArrays = _this.shuffle(_this.qArrays);
        ...
        background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level71_backg');
    ...
    generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX, 15, 'CommonStarAnim');
			for(var j =0;j<i;j++)
			{
 ...
 gotoFirstQuestion:function(){
   ...
   onDragStart:function(target){
    ...
    onDragStop:function(target){
        //console.log("vvvvvvv "+_this.correctflag);
         ////console.log("grouplen=="+_this.randomgrp.length);
//       ////console.log("one"+_this.randomgrp.getChildAt(0).name);
//        ////console.log("two"+_this.randomgrp.getChildAt(1).name);
//        ////console.log("three"+_this.randomgrp.getChildAt(2).name);
//        ////console.log("four"+_this.randomgrp.getChildAt(3).name);
        for(var i=0;i<_this.randomgrp.length;i++)
        {
                           ...
                           _this.time.events.add(1100,function(){
                                ...
                                _this.circlegraphics2.events.onInputDown.add(function(){
                                   ...
                                   /* _this.noofAttempts++
                                    ...
                                    //absdsjsapi.saveInteractEvent(interactEvent);*/
                                                   // _this.wrongAns(_this.circlegraphics2);
            ...
            case "m": //Eng_71M.play();
                _this.circlegraphics1.events.onInputDown.add(function(){
                            _this.noofAttempts++;
                               ...
                               // _this.wrongAns(_this.circlegraphics1);
                                 _this.wmusic = _this.add.audio('waudio');
                                _this.wmusic.play();
                                  _this.shake.shake(10, _this.clockgroup);
                                },_this); //get voice for hour hand
	...
	correctAns:function()
	{
        ...
        if(timer!=null)
                    ...
                    var currentTime = window.timeSaveFunc();
                    //console.log(_this.savedVar,_this.questionid,_this.AnsTimerCount,_this.noofAttempts,currentTime,window.acctkn);
       ...
       // _this.noofAttempts++;
        _this.stopvoice();
        //target.events.onInputDown.removeAll(); 
       // ////console.log("count1count1count1count1count1count1count1"+count1);
       // _this.noofAttempts++;
        _this.clock.frame=1;
		...
		//celebAnim = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'celeb');
