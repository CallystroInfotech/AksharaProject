...
init:function(game)
    ...
    addQuestion:function(no2)
    {
     ...
     gotoFirstQuestion:function(){
         ...
         box2=this.add.sprite(120,400,'Level42B_box');
         box2.scale.setTo(1,0.8);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(385,400,'Level42B_box');
         box1.scale.setTo(1,0.8);
         box1.alpha=0;
         box1.name="opt2box";
         
         box=this.add.sprite(635,400,'Level42B_box');
    ...
    gotoSecondQuestion:function(){
        ...
        sh3.alpha=0.5;
         ...
         box2=this.add.sprite(124,400,'Level42B_box');
         box2.scale.setTo(1,0.8);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(383,400,'Level42B_box');
         box1.scale.setTo(1,0.8);
         box1.alpha=0;
         box1.name="opt2box";
         
         box=this.add.sprite(637,400,'Level42B_box');
        box.scale.setTo(1,0.8);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
      ...
      gotoThirdQuestion:function(){
         ...
         box2=this.add.sprite(115,400,'Level42B_box');
         box2.scale.setTo(1,0.8);
         box2.alpha=0;
         box2.name="opt3box";
       ...
       gotoFourthQuestion:function(){
         ...
         box=this.add.sprite(638,400,'Level42B_box');
        box.scale.setTo(1,0.8);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
     ...
     gotoFifthQuestion:function(){
    	...
    	no1++;
         ...
         box1=this.add.sprite(400,400,'Level42B_box');
         box1.scale.setTo(1,0.8);
         box1.alpha=0;
         box1.name="opt2box";
  ...
  wronggraphics3.alpha = 0;
    ...
    gotoSixthQuestion:function(){
        ...
        sh3.alpha=0.5;
         ...
         box=this.add.sprite(628,400,'Level42B_box');
        box.scale.setTo(1,0.8);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
     ...
     gotoSeventhQuestion:function(){
    	...
    	no1++;
         ...
         box=this.add.sprite(631,400,'Level42B_box');
        box.scale.setTo(1,0.8);
         box.alpha=0; 
         box.name="opt1box";
         box.inputEnabled=true;
     ...
     wronggraphics2.alpha = 0;
      ...
      gotoEighthQuestion:function(){
        ...
        boxb1=this.add.sprite(155,420,'Level42B_boxb');
         ...
         box2=this.add.sprite(122,400,'Level42B_box');
         box2.scale.setTo(1,0.8);
         box2.alpha=0;
         box2.name="opt3box";
         
         box1=this.add.sprite(391,400,'Level42B_box');
         box1.scale.setTo(1,0.8);
         box1.alpha=0;
         box1.name="opt2box";
