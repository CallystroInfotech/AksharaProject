       ...
       // Caterpillar colored bodies 
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_3_3start', 30, true);
	...
	correctAns:function(target)
	{
        ...
        {   
            ...
            {   
                ...
                _this.Caterpillar_head.animations.play('Unity2_3_3Caterpillar_Happy',null,true);
            }
        ...
        {     
            ...
            if (_this.Caterpillar_head.key == 'Unity2_3_3start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_3_3wrong',null,true);
            }
