       ...
       /* _this.opt1.events.onInputOver.add(function(target){
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_3start', 30, true);
	...
	correctAns:function(target)
	{
        ...
        */
        ...
        if(_this.dragedTxt === _this.rightAns)
        {
            ...
            {
                _this.Caterpillar_head.loadTexture('Unity2_5_3Caterpillar_Happy', 0);
                _this.Caterpillar_head.animations.add('Unity2_5_3Caterpillar_Happy');
                _this.Caterpillar_head.animations.play('Unity2_5_3Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'start')
            {
                ...
                _this.Caterpillar_head.loadTexture('Unity2_5_3wrong', 0);
                _this.Caterpillar_head.animations.add('Unity2_5_3wrong');
                _this.Caterpillar_head.animations.play('Unity2_5_3wrong',null,true);
            }
