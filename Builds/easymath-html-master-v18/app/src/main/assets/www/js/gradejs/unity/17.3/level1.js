...
Game.unity17_3level1.prototype={
	...
	create:function(game){
      ...
      // _this.speakerbtn.inputEnabled = true;
        ...
        _this.coinPannel = _this.add.sprite(40,105,'Level321_coinMachinePannel17_2');
        _this.coinPannel.scale.setTo(0.95,1.1);
      ...
      _this.Levercoin10 = _this.add.sprite(355,168,'Level321_coin10Anim');
        ...
        _this.topbar = _this.add.sprite(400,50,'Level321_5');
...
counted1=0;
  ...
  addYellowCoins:function(){
    ...
    addNumberPad:function(){
        ...
        txtbox1 = objGroup.create(90,72,'Level172_ansbox');
