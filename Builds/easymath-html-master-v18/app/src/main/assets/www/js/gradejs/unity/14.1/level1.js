...
Game.unity14_1level1.prototype={
  ...
  return array;
    ...
    gotoquestion1:function(){
        ...
        horiznum = this.add.text(680,93,_this.firstno);
        ...
        vertinum = this.add.text(760,93,_this.secondno);
    ...
    //    _this.gridarea.scale.setTo(0.85,0.85);
        ...
        //console.log("remainder=="+_this.remainder);
        horiznum = this.add.text(680,90,_this.firstno);
        horiznum.fill = '#65B4C3';
        horiznum.font = "myfont";
        ...
        vertinum = this.add.text(760,90,_this.secondno);
        vertinum.fill = '#65B4C3';
        vertinum.font = "myfont";
    ...
    wrongAns:function(){
        ...
        shakeGroup.x = this.world.centerX;
        shakeGroup.y = this.world.centerY;
        shakeGroup.pivot.setTo(this.world.centerX+20,this.world.centerY);
        shakeGroup.angle = 0;
