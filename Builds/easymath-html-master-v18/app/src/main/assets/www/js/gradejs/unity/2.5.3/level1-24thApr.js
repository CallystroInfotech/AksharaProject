...
Game.unity2_4_3level1.prototype ={
    ...
    {  
        ...
        _this.Caterpillar_head = _this.add.sprite(_this.world.centerX-150,_this.world.centerY-80,'Unity2_4_3start');  
        _this.Caterpillar_head.name = "start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
        
        _this.Neutral =_this.Caterpillar_head.animations.add('Unity2_4_3start');
    ...
    {                                  
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_3start', 30, true);
    ...
    gotoFifthQuestion:function()
    {
        ...
        _this.Caterpillar_head= _this.add.sprite(_this.world.centerX-150,_this.world.centerY-70,'Unity2_4_3start');  
        _this.Caterpillar_head.name = "start";
        _this.Caterpillar_head.anchor.setTo(0.5);
        _this.Caterpillar_head.scale.setTo(0.6,0.6);
	...
	correctAns:function(target)
	{
        ...
        if(correct)
        {
            ...
            if (_this.Caterpillar_head.key == 'Unity2_4_3start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_3Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'Unity2_4_3start')
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_3wrong',null,true);
            }
