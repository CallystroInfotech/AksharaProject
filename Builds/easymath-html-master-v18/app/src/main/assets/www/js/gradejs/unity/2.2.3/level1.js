...
Game.unity2_2_3level1.prototype ={
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_3_start', 30, true);
    ...
    gotoFourthQuestion:function()
    {
        ...
        _this.Neutral =_this.Caterpillar_head.animations.add('unity2_2_3_start');
        _this.Caterpillar_head.animations.play('unity2_2_3_tart', 30, true);
...
//                
        ...
        if(correct)
        {
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_3_start')
            {
                ...
                _this.Caterpillar_head.animations.play('unity2_2_3_Caterpillar_Happy',null,true);
            }
        ...
        {     
           ...
           //_this.currentTime = window.timeSaveFunc();
            ...
            if (_this.Caterpillar_head.key == 'unity2_2_3_start')
            {
                ...
                _this.Caterpillar_head.animations.play('unity2_2_3_wrong',null,true);
            }
