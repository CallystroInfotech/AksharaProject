    ...
    getQuestion:function()
     {
        ...
        dragcount = 0;
         this.questionid = "Game8.1#SCR-"+this.sceneCount;
    	switch(qArrays[no11])
       //switch(no11)
    	{
    		case 1: 
...
//timer.setText(minutes + ':'+ seconds );
    ...
    gotoFirstQuestion:function(){
        ...
        var RabitAnim = this.add.sprite(140,386,'grade81_RabitAnim','Symbol 2 instance 10000');
     ...
     /*  
       ...
       //console.log("greennum1=="+Number(greenNumbers1.frame+1));
        ...
        bottomBar.name="grade81_bottomBar";
            ...
            var calNum1=this.add.sprite(120,505,'grade81_calNum');
        calNum1.name="grade81_calNum1";
            calNum1.anchor.setTo(0.5);
            calNum1.scale.setTo(0.5,0.5);
            calNum1.frame=1;
...
//            }
            ...
            var calNum2=this.add.sprite(180,505,'grade81_calNum');
        calNum2.name="grade81_calNum2";
            calNum2.anchor.setTo(0.5);
            calNum2.scale.setTo(0.5,0.5);
            calNum2.frame=2;
...
//            }
            ...
            var calNum3=this.add.sprite(240,505,'grade81_calNum');
        calNum3.name="grade81_calNum3";
            calNum3.anchor.setTo(0.5);
            calNum3.scale.setTo(0.5,0.5);
            calNum3.frame=3;
...
//            }
            ...
            var calNum4=this.add.sprite(300,505,'grade81_calNum');
        calNum4.name="grade81_calNum4";
            calNum4.anchor.setTo(0.5);
            calNum4.scale.setTo(0.5,0.5);
            calNum4.frame=4;
...
//            }
            ...
            var calNum5=this.add.sprite(360,505,'grade81_calNum');
        calNum5.name="grade81_calNum5";
            calNum5.anchor.setTo(0.5);
            calNum5.scale.setTo(0.5,0.5);
            calNum5.frame=5;
...
//            }
            ...
            var calNum6=this.add.sprite(420,505,'grade81_calNum');
        calNum6.name="grade81_calNum6";
            calNum6.anchor.setTo(0.5);
            calNum6.scale.setTo(0.5,0.5);
            calNum6.frame=6;
...
//            }
            ...
            var calNum7=this.add.sprite(480,505,'grade81_calNum');
        calNum7.name="grade81_calNum7";
            calNum7.anchor.setTo(0.5);
            calNum7.scale.setTo(0.5,0.5);
            calNum7.frame=7;
...
//            }
            ...
            var calNum8=this.add.sprite(540,505,'grade81_calNum');
        calNum8.name="grade81_calNum8";
            calNum8.anchor.setTo(0.5);
            calNum8.scale.setTo(0.5,0.5);
            calNum8.frame=8;
...
//            }
            ...
            var calNum9=this.add.sprite(600,505,'grade81_calNum');
        calNum9.name="grade81_calNum9";
            calNum9.anchor.setTo(0.5);
            calNum9.scale.setTo(0.5,0.5);
            calNum9.frame=9;
...
//            }
            ...
            var calNum0=this.add.sprite(660,505,'grade81_calNum');
        calNum0.name="grade81_calNum0";
            calNum0.anchor.setTo(0.5);
            calNum0.scale.setTo(0.5,0.5);
            calNum0.frame=0;
...
//            }
       ...
       //console.log("pressed=="+pressed);
            ...
            tick=this.add.sprite(820,505,'grade81_tick');
        tick.name="grade81_tick";
            tick.anchor.setTo(0.5);
            tick.scale.setTo(0.5,0.5);
            tick.frame=0;
          ...
          tick.input.useHandCursor = true;
            ...
            eraser=this.add.sprite(740,505,'grade81_eraser');
        eraser.name="grade81_eraser";
            eraser.anchor.setTo(0.5);
            eraser.scale.setTo(0.5,0.5);
            eraser.frame=0;
            eraser.inputEnabled=true;
          eraser.input.useHandCursor = true;
            eraser.events.onInputDown.add(function(){
                 var clickeraser = this.add.audio('Tap');
                clickeraser.play();
                eraser.frame=1;
                this.time.events.add(500, function(){
                eraser.frame=0;
