...
init:function(game)
    ...
    addNumberPad:function(){
        ...
        wrongbtn = numGroup.create(x+45,505,'Level42A_eraser','Symbol 14 copy 5 instance 10000');
        //wrongbtn.scale.setTo(0.95,0.98);
        wrongbtn.anchor.setTo(0.5);
        wrongbtn.name = "wrongbtn";

        rightbtn = numGroup.create(x+115,506,'Level42A_rightBtn','Symbol 14 copy instance 10000');
