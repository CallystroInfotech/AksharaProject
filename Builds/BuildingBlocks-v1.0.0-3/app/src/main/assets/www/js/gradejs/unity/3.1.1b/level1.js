...
gotoFirstQuestion:function()
    {
        ...
        _this.dcoin1 =_this.add.sprite(520,270,'unity3_1_2coin');
        _this.dcoin1.anchor.setTo(0.5); 
        _this.dcoin1.scale.setTo(0.7,0.8); 
        _this.dcoin1.frame=0;
        
         _this.hand = _this.add.sprite(520,270,'Unity4_1_1hand');
         _this.time.events.add(500, function(){  
         var tween1 = _this.add.tween(_this.dcoin1);
         tween1.to({ x:120 , y:270}, 1500, 'Linear', true, 0);
...
gotoFourthQuestion:function(){
      ...
      _this.getVoice();
        ...
        _this.dcoin1 =_this.add.sprite(520,330,'unity3_1_2box');
        _this.dcoin1.anchor.setTo(0.5); 
        _this.dcoin1.scale.setTo(0.85,1); 
        _this.dcoin1.frame=0;
        
         _this.hand = _this.add.sprite(520,330,'Unity4_1_1hand');
         _this.time.events.add(500, function(){  
         var tween1 = _this.add.tween(_this.dcoin1);
         tween1.to({ x:120 , y:270}, 1500, 'Linear', true, 0);
         var tween1 = _this.add.tween(_this.hand);
...
gotoFifthQuestion:function(){
     ...
     */
       ...
       // _this.dragcoinGrp.add(_this.dragcoin21);
        ...
        _this.dcoin1 =_this.add.sprite(520,270,'unity3_1_2box');
        _this.dcoin1.anchor.setTo(0.5); 
        _this.dcoin1.scale.setTo(0.85,1); 
        _this.dcoin1.frame=0;
...
gotoSixthQuestion:function(){
       ...
       /* _this.coinp =_this.add.sprite(150,235,'unity3_1_2boxanim');
        ...
        _this.coinp.frame=0;
       */
        _this.coinp2 =_this.add.sprite(200,270,'unity3_1_2boxanim');
        _this.coinp2.anchor.setTo(0.5);
        _this.coinp2.scale.setTo(1,1.1); 
        _this.coinp2.visible=false;
        _this.coinp2.frame=0;
