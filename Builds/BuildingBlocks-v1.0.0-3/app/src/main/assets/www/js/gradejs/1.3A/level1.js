...
//        scoretext.setText(selctedLang.score+' : '+score);
    ...
    {   
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3A/English/1.1A2.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3A/Hindi/1.1A2.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3A/Kannada/1.1A2.mp3");
        }
		else
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.3A/Odiya/1.1A2.mp3");
