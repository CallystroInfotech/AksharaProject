...
Game.preloader.prototype={
	...
	preload:function(){
		...
		this.load.video('demo7_1_1',window.baseUrl+'assets/demoVideos/7_1_1.mp4');
		//this.load.video('demo',window.baseUrl+'assets/demoVideos/demo.mp4');
		/*this.load.video('demo3_2_1',window.baseUrl+'assets/demoVideos/3_2_1.webm');
		this.load.video('demo3_2_2',window.baseUrl+'assets/demoVideos/3_2_2.webm');
		this.load.video('demo7_1_1',window.baseUrl+'assets/demoVideos/7_1_1.webm');
		this.load.video('demo7_1_2',window.baseUrl+'assets/demoVideos/7_1_2.webm');
		this.load.video('demo7_1_3',window.baseUrl+'assets/demoVideos/7_1_3.webm');
		this.load.video('demo7_2_1',window.baseUrl+'assets/demoVideos/7_2_1.webm');
		this.load.video('demo7_2_2',window.baseUrl+'assets/demoVideos/7_2_2.webm');
		this.load.video('demo7_2_3',window.baseUrl+'assets/demoVideos/7_2_3.webm');
		this.load.video('demo10_1_1',window.baseUrl+'assets/demoVideos/10_1_1.webm');
		this.load.video('demo10_1_2',window.baseUrl+'assets/demoVideos/10_1_2.webm');
		this.load.video('demo10_1_3',window.baseUrl+'assets/demoVideos/10_1_3.webm');
		this.load.video('demo10_2_1',window.baseUrl+'assets/demoVideos/10_2_1.webm');
		this.load.video('demo10_2_2',window.baseUrl+'assets/demoVideos/10_2_2.webm');
		this.load.video('demo10_2_3',window.baseUrl+'assets/demoVideos/10_2_3.webm');
		this.load.video('demo17_2',window.baseUrl+'assets/demoVideos/17_2.webm');
		this.load.video('demo17_3',window.baseUrl+'assets/demoVideos/17_3.webm');*/
		...
		/*this.checkDirExistsorNot(window.directoryPath+"www/Measurement1",_this.loadMeasurement1Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberSense1",_this.loadNumberSense1Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberOperation1",_this.loadNumberOperation1Assets);


		this.checkDirExistsorNot(window.directoryPath+"www/Measurement2",_this.loadMeasurement2Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberSense2",_this.loadNumberSense2Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberOperation2",_this.loadNumberOperation2Assets);

		this.checkDirExistsorNot(window.directoryPath+"www/Measurement3",_this.loadMeasurement3Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberSense3",_this.loadNumberSense3Assets);
		this.checkDirExistsorNot(window.directoryPath+"www/NumberOperation3",_this.loadNumberOperation3Assets);
		
		this.checkDirExistsorNot(window.directoryPath+"www/Measurement4",_this.loadMeasurement4Assets);*/
	...
	loadCommonAssets:function()
	{
		...
		_this.load.image('common_timebg',window.baseUrl+'assets/commonAssets/common_timebg.png');
		_this.load.image('dottedBox',window.baseUrl+'assets/commonAssets/dottedBox.png');
	...
	{
		_this.load.image('Level22_bg',window.baseUrl+'assets/gradeAssets/2.2/commonAssets/bg.png');
	...
	*/
	addgame1_2AAssets:function()
	{
		this.load.image('unity1.2Abg',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/bg.png');
        this.load.image('unity1.2Abackg',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/backg.png');
        this.load.image('unity1.2Atopbar', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/topbar.png');
        this.load.image('unity1.2Atimerbg', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/timerbg.png');
        this.load.image('unity1.2Adotbox', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/dotbox.png');
        this.load.image('unity1.2Anumbg', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/numbg.png');
		this.load.image('unity1.2AtittleBar', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/tittleBaar.png');
       
        this.load.atlas('unity1.2Abackbtn',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/1.2A/backbtn.json');
        this.load.atlas('unity1.2Aspeaker',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/1.2A/speaker.json');
        this.load.atlas('unity1.2AstarAnim',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/1.2A/starAnim.json');
        this.load.atlas('unity1.2Abtn',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/btn.png',window.baseUrl+'json/gradeJson/1.2A/btn.json');
        this.load.atlas('unity1.2Areplay', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/reply.png', window.baseUrl+'json/gradeJson/1.2A/reply.json');
	...
	{
		this.load.image('unity1.2Bbg',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/bg.png');
        this.load.image('unity1.2Bbackg',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/backg.png');
        this.load.image('unity1.2Btopbar', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/topbar.png');
        this.load.image('unity1.2Btimerbg', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/timerbg.png');
        this.load.image('unity1.2Bdotbox', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/dotbox.png');
        this.load.image('unity1.2Bnumbg', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/numbg.png');
		this.load.image('unity1.2BtittleBar', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/tittleBaar.png');
       
        this.load.atlas('unity1.2Bbackbtn',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/1.2A/backbtn.json');
        this.load.atlas('unity1.2Bspeaker',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/1.2A/speaker.json');
        this.load.atlas('unity1.2BstarAnim',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/1.2A/starAnim.json');
        this.load.atlas('unity1.2Bbtn',window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/btn.png',window.baseUrl+'json/gradeJson/1.2A/btn.json');
        this.load.atlas('unity1.2Breplay', window.baseUrl+'assets/gradeAssets/1.2A/commonAssets/reply.png', window.baseUrl+'json/gradeJson/1.2A/reply.json');
	...
	addgame5_4Assets:function()
	{
      ...
      /*  this.load.atlas('Level54_main_imageanim',window.baseUrl+'assets/gradeAssets/5.4/main_imageanim.png' ,window.baseUrl+'json/gradeJson/5.4/main_imageanim.json');
        ...
        //common assets
        this.load.image('Level54_bg1',window.baseUrl+'assets/gradeAssets/5.4/commonAssets/bg1.png');
	...
	{
		this.load.image('Level72_bg1',window.baseUrl+'assets/gradeAssets/commonAssets/BG.png');
        this.load.image('Level72_bg2',window.baseUrl+'assets/gradeAssets/commonAssets/bg2.png');
        
        this.load.atlas('numbg',window.baseUrl+'assets/gradeAssets/commonAssets/numbg.png' ,window.baseUrl+'json/gradeJson/7.2/numbg.json');
        this.load.atlas('rightBtn',window.baseUrl+'assets/gradeAssets/commonAssets/rightBtn.png' ,window.baseUrl+'json/gradeJson/7.2/rightBtn.json');
        this.load.atlas('wrongBtn',window.baseUrl+'assets/gradeAssets/commonAssets/wrongBtn.png' ,window.baseUrl+'json/gradeJson/7.2/wrongBtn.json');
        ...
        /* this.load.image('minHand',window.baseUrl+'assets/gradeAssets/7.2/minuteHand-old.png');
         this.load.image('hourHand',window.baseUrl+'assets/gradeAssets/7.2/hourHand.png');*/
	...
	addunitygame1_1Assets:function()
	{
		...
		this.load.atlas('unity1_1backbtn',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.1/backbtn.json');
        this.load.atlas('unity1_1CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.1/speaker.json');
        this.load.atlas('unity1_1starAnim',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.1/starAnim.json');
        this.load.atlas('unity1_1replay',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.1/reply.json');
        this.load.atlas('unity1_1btn',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.1/btn.json');
        
        this.load.image('unity1_1tittleBar',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/tittleBar.png');
        this.load.image('unity1_1background',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/bg.png');
        this.load.image('unity1_1navBar',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/navBar.png');
        this.load.image('unity1_1timebg',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/timebg.png');
        this.load.image('unity1_1topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.1/commonAssets/topicOutline.png');
	...
	{
		this.load.image('unity1_2bg1',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/BG.png');
        this.load.atlas('unity1_2CommonBackBtn',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.2/backbtn.json');
        this.load.atlas('unity1_2CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.2/speaker.json');
        this.load.atlas('unity1_2starAnim',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.2/starAnim.json');
        this.load.atlas('unity1_2btn',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.2/btn.json');
        this.load.image('unity1_2bg3',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/bg3.png');
        this.load.image('unity1_2tittleBaar',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/tittleBaar.png');
        this.load.atlas('unity1_2replay',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.2/reply.json');
        ...
        this.load.atlas('unity1_2tickBtn',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/tick.png' ,window.baseUrl+'json/gradeJson/unity/1.2/tick.json');
         this.load.image('unity1_2navBar',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/navBar.png');
        ...
        this.load.image('unity1_2topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/topicOutline.png');
        this.load.image('unity1_2timebg',window.baseUrl+'assets/gradeAssets/unity/1.2/commonAssets/timebg.png');
	...
	{
		this.load.image('unity13_bg1',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/BG.png');
        this.load.atlas('unity13_backbtn',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.3/backbtn.json');
        this.load.atlas('unity13_CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.3/speaker.json');
        this.load.atlas('unity13_starAnim',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.3/starAnim.json');
        this.load.atlas('unity13_btn',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.3/btn.json');
        this.load.image('unity13_bg3',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/bg3.png');
        this.load.image('unity13_tittleBaar',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/tittleBaar.png');
        this.load.atlas('unity13_replay',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.3/reply.json');
       ...
       // this.load.atlas('NumberKey',window.baseUrl+'assets/gradeAssets/unity/NumberKey.png' ,window.baseUrl+'json/gradeJson/unity/1.3/NumberKey.json');
        this.load.image('unity13_navBar',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/navBar.png');
        this.load.image('unity13_numbg',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/numbg.png');
        ...
        this.load.image('unity13_topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/topicOutline.png');
        this.load.image('unity13_timebg',window.baseUrl+'assets/gradeAssets/unity/1.3/commonAssets/timebg.png');
	...
	addunitygame1_4Assets:function()
	{
		...
		this.load.atlas('unity1_4backbtn',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.4/backbtn.json');
        this.load.atlas('unity1_4CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.4/speaker.json');
        this.load.atlas('unity1_4starAnim',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.4/starAnim.json');
        this.load.atlas('unity1_4replay',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.4/reply.json');
        this.load.atlas('unity1_4btn',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.4/btn.json');
        
        this.load.image('unity1_4tittleBar',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/tittleBar.png');
        this.load.image('unity1_4background',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/bg.png');
        this.load.image('unity1_4navBar',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/navBar.png');
        this.load.image('unity1_4timebg',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/timebg.png');
        this.load.image('unity1_4topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.4/commonAssets/topicOutline.png');
	...
	{
		this.load.image('unity15_bg1',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/BG.png');
        this.load.atlas('unity15_CommonBackBtn',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.5/backbtn.json');
        this.load.atlas('unity15_CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.5/speaker.json');
        this.load.atlas('unity15_starAnim',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.5/starAnim.json');
        this.load.atlas('unity15_btn',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.5/btn.json');
        this.load.image('unity15_bg3',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/bg3.png');
        this.load.image('unity15_tittleBaar',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/tittleBaar.png');
        this.load.atlas('unity15_replay',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.5/reply.json');
        ...
        this.load.atlas('unity15_tickBtn',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/tick.png' ,window.baseUrl+'json/gradeJson/unity/1.5/tick.json');
         this.load.image('unity15_navBar',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/navBar.png');
        ...
        this.load.image('unity15_topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/topicOutline.png');
        this.load.image('unity15_timebg',window.baseUrl+'assets/gradeAssets/unity/1.5/commonAssets/timebg.png');
	...
	{
		this.load.atlas('unity16_CommonBackBtn',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/unity/1.6/backbtn.json');
        this.load.atlas('unity16_CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/unity/1.6/speaker.json');
        this.load.atlas('unity16_starAnim',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/unity/1.6/starAnim.json');
        this.load.image('unity16_tittleBar',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/tittleBar.png');
        this.load.atlas('unity16_replay',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/unity/1.6/reply.json');
        this.load.atlas('unity16_btn',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/btn.png',window.baseUrl+'json/gradeJson/unity/1.6/btn.json');
        this.load.image('unity16_background',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/bg.png');
        ...
        this.load.image('unity16_Bubble', window.baseUrl+'assets/gradeAssets/unity/1.6/Bubble.png');
         ...
         this.load.image('unity16_navBar',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/navBar.png');
        ...
        this.load.image('unity16_topicOutline',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/topicOutline.png');
        this.load.image('unity16_timebg',window.baseUrl+'assets/gradeAssets/unity/1.6/commonAssets/timebg.png');
	...
	{
		this.load.atlas('unity2_1_1_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.1.1/backbtn.json');
        this.load.atlas('unity2_1_1_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.1.1/speaker.json');
        this.load.atlas('unity2_1_1_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.1.1/starAnim.json');
        this.load.atlas('unity2_1_1_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.1.1/reply.json');
        this.load.atlas('unity2_1_1_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.1.1/btn.json');
        
        this.load.image('unity2_1_1_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_1_1_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_1_1_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_1_1_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_1_1_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('unity2_1_2_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.1.2/backbtn.json');
        this.load.atlas('unity2_1_2_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.1.2/speaker.json');
        this.load.atlas('unity2_1_2_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.1.2/starAnim.json');
        this.load.atlas('unity2_1_2_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.1.2/reply.json');
        this.load.atlas('unity2_1_2_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.1.2/btn.json');
        
        this.load.image('unity2_1_2_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_1_2_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_1_2_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_1_2_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_1_2_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('unity2_1_3_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.1.3/backbtn.json');
        this.load.atlas('unity2_1_3_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.1.3/speaker.json');
        this.load.atlas('unity2_1_3_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.1.3/starAnim.json');
        this.load.atlas('unity2_1_3_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.1.3/reply.json');
        this.load.atlas('unity2_1_3_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.1.3/btn.json');
        
        this.load.image('unity2_1_3_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_1_3_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_1_3_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_1_3_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_1_3_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('unity2_2_1_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.2.1/backbtn.json');
        this.load.atlas('unity2_2_1_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.2.1/speaker.json');
        this.load.atlas('unity2_2_1_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.2.1/starAnim.json');
        this.load.atlas('unity2_2_1_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.2.1/reply.json');
        this.load.atlas('unity2_2_1_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.2.1/btn.json');
        
        this.load.image('unity2_2_1_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_2_1_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_2_1_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_2_1_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_2_1_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		this.load.atlas('unity2_2_2_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.2.2/backbtn.json');
        this.load.atlas('unity2_2_2_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.2.2/speaker.json');
        this.load.atlas('unity2_2_2_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.2.2/starAnim.json');
        this.load.atlas('unity2_2_2_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.2.2/reply.json');
        this.load.atlas('unity2_2_2_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.2.2/btn.json');
        
        this.load.image('unity2_2_2_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_2_2_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_2_2_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_2_2_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_2_2_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('unity2_2_3_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.2.3/backbtn.json');
        this.load.atlas('unity2_2_3_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.2.3/speaker.json');
        this.load.atlas('unity2_2_3_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.2.3/starAnim.json');
        this.load.atlas('unity2_2_3_replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.2.3/reply.json');
        this.load.atlas('unity2_2_3_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.2.3/btn.json');
        
        this.load.image('unity2_2_3_background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_2_3_tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('unity2_2_3_navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('unity2_2_3_timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('unity2_2_3_topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		this.load.atlas('Unity2_3_1backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.3.1/backbtn.json');
        this.load.atlas('Unity2_3_1CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.3.1/speaker.json');
        this.load.atlas('Unity2_3_1starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.3.1/starAnim.json');
        this.load.atlas('Unity2_3_1replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.3.1/reply.json');
        this.load.atlas('Unity2_3_1btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.3.1/btn.json');
        
        this.load.image('Unity2_3_1background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_3_1tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_3_1navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_3_1timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_3_1topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_3_2backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.3.2/backbtn.json');
        this.load.atlas('Unity2_3_2CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.3.2/speaker.json');
        this.load.atlas('Unity2_3_2starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.3.2/starAnim.json');
        this.load.atlas('Unity2_3_2replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.3.2/reply.json');
        this.load.atlas('Unity2_3_2btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.3.2/btn.json');
        
        this.load.image('Unity2_3_2background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_3_2tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_3_2navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_3_2timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_3_2topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_3_3backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.3.3/backbtn.json');
        this.load.atlas('Unity2_3_3CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.3.3/speaker.json');
        this.load.atlas('Unity2_3_3starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.3.3/starAnim.json');
        this.load.atlas('Unity2_3_3replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.3.3/reply.json');
        this.load.atlas('Unity2_3_3btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.3.3/btn.json');
        
        this.load.image('Unity2_3_3background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_3_3tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_3_3navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_3_3timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_3_3topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_4_1backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.4.1/backbtn.json');
        this.load.atlas('Unity2_4_1CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.4.1/speaker.json');
        this.load.atlas('Unity2_4_1starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.4.1/starAnim.json');
        this.load.atlas('Unity2_4_1replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.4.1/reply.json');
        this.load.atlas('Unity2_4_1btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.4.1/btn.json');
        
        this.load.image('Unity2_4_1background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_4_1tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_4_1navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_4_1timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_4_1topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_4_2backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.4.2/backbtn.json');
        this.load.atlas('Unity2_4_2CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.4.2/speaker.json');
        this.load.atlas('Unity2_4_2starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.4.2/starAnim.json');
        this.load.atlas('Unity2_4_2replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.4.2/reply.json');
        this.load.atlas('Unity2_4_2btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.4.2/btn.json');
        
        this.load.image('Unity2_4_2background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_4_2tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_4_2navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_4_2timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_4_2topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_4_3backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.4.3/backbtn.json');
        this.load.atlas('Unity2_4_3CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.4.3/speaker.json');
        this.load.atlas('Unity2_4_3starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.4.3/starAnim.json');
        this.load.atlas('Unity2_4_3replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.4.3/reply.json');
        this.load.atlas('Unity2_4_3btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.4.3/btn.json');
        
        this.load.image('Unity2_4_3background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_4_3tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_4_3navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_4_3timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_4_3topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_5_1backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.5.1/backbtn.json');
        this.load.atlas('Unity2_5_1CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.5.1/speaker.json');
        this.load.atlas('Unity2_5_1starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.5.1/starAnim.json');
        this.load.atlas('Unity2_5_1replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.5.1/reply.json');
        this.load.atlas('Unity2_5_1btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.5.1/btn.json');
        
        this.load.image('Unity2_5_1background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_5_1tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_5_1navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_5_1timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_5_1topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_5_2backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.5.2/backbtn.json');
        this.load.atlas('Unity2_5_2CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.5.2/speaker.json');
        this.load.atlas('Unity2_5_2starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.5.2/starAnim.json');
        this.load.atlas('Unity2_5_2replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.5.2/reply.json');
        this.load.atlas('Unity2_5_2btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.5.2/btn.json');
        
        this.load.image('Unity2_5_2background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_5_2tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_5_2navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_5_2timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_5_2topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity2_5_3backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.5.3/backbtn.json');
        this.load.atlas('Unity2_5_3CommonSpeakerBtn',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.5.3/speaker.json');
        this.load.atlas('Unity2_5_3starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.5.3/starAnim.json');
        this.load.atlas('Unity2_5_3replay',window.baseUrl+'assets/commonAssets2/reply.png' ,window.baseUrl+'json/gradeJson/2.5.3/reply.json');
        this.load.atlas('Unity2_5_3btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.5.3/btn.json');
        
        this.load.image('Unity2_5_3background',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('Unity2_5_3tittleBar',window.baseUrl+'assets/commonAssets2/tittleBar.png');
        this.load.image('Unity2_5_3navBar',window.baseUrl+'assets/commonAssets2/navBar.png');
        this.load.image('Unity2_5_3timebg',window.baseUrl+'assets/commonAssets2/timebg.png');
        this.load.image('Unity2_5_3topicOutline',window.baseUrl+'assets/commonAssets2/topicOutline.png');
	...
	{
		this.load.image('unity2_6_1_bg',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_6_1_backg',window.baseUrl+'assets/commonAssets2/backg.png');
        this.load.image('unity2_6_1_topbar', window.baseUrl+'assets/commonAssets2/topbar.png');
        this.load.image('unity2_6_1_timerbg', window.baseUrl+'assets/commonAssets2/timerbg.png');
        this.load.image('unity2_6_1_dotbox', window.baseUrl+'assets/commonAssets2/dotbox.png');
        this.load.image('unity2_6_1_numbg', window.baseUrl+'assets/commonAssets2/numbg.png');
		this.load.image('unity2_6_1_tittleBar', window.baseUrl+'assets/commonAssets2/tittleBaar.png');
       
        this.load.atlas('unity2_6_1_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.6.1/backbtn.json');
        this.load.atlas('unity2_6_1_speaker',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.6.1/speaker.json');
        this.load.atlas('unity2_6_1_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.6.1/starAnim.json');
        this.load.atlas('unity2_6_1_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.6.1/btn.json');
        this.load.atlas('unity2_6_1_replay', window.baseUrl+'assets/commonAssets2/reply.png', window.baseUrl+'json/gradeJson/2.6.1/reply.json');
	...
	{
		this.load.image('unity2_6_2_bg',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_6_2_backg',window.baseUrl+'assets/commonAssets2/backg.png');
        this.load.image('unity2_6_2_topbar', window.baseUrl+'assets/commonAssets2/topbar.png');
        this.load.image('unity2_6_2_timerbg', window.baseUrl+'assets/commonAssets2/timerbg.png');
        this.load.image('unity2_6_2_dotbox', window.baseUrl+'assets/commonAssets2/dotbox.png');
        this.load.image('unity2_6_2_numbg', window.baseUrl+'assets/commonAssets2/numbg.png');
		this.load.image('unity2_6_2_tittleBar', window.baseUrl+'assets/commonAssets2/tittleBaar.png');
       
        this.load.atlas('unity2_6_2_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.6.2/backbtn.json');
        this.load.atlas('unity2_6_2_speaker',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.6.2/speaker.json');
        this.load.atlas('unity2_6_2_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.6.2/starAnim.json');
        this.load.atlas('unity2_6_2_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.6.2/btn.json');
        this.load.atlas('unity2_6_2_replay', window.baseUrl+'assets/commonAssets2/reply.png', window.baseUrl+'json/gradeJson/2.6.2/reply.json');
	...
	{
		this.load.image('unity2_6_3_bg',window.baseUrl+'assets/commonAssets2/bg.png');
        this.load.image('unity2_6_3_backg',window.baseUrl+'assets/commonAssets2/backg.png');
        this.load.image('unity2_6_3_topbar', window.baseUrl+'assets/commonAssets2/topbar.png');
        this.load.image('unity2_6_3_timerbg', window.baseUrl+'assets/commonAssets2/timerbg.png');
        this.load.image('unity2_6_3_dotbox', window.baseUrl+'assets/commonAssets2/dotbox.png');
        this.load.image('unity2_6_3_numbg', window.baseUrl+'assets/commonAssets2/numbg.png');
		this.load.image('unity2_6_3_tittleBar', window.baseUrl+'assets/commonAssets2/tittleBaar.png');
       
        this.load.atlas('unity2_6_3_backbtn',window.baseUrl+'assets/commonAssets2/backbtn.png' ,window.baseUrl+'json/gradeJson/2.6.3/backbtn.json');
        this.load.atlas('unity2_6_3_speaker',window.baseUrl+'assets/commonAssets2/speaker.png' ,window.baseUrl+'json/gradeJson/2.6.3/speaker.json');
        this.load.atlas('unity2_6_3_starAnim',window.baseUrl+'assets/commonAssets2/starAnim.png',window.baseUrl+'json/gradeJson/2.6.3/starAnim.json');
        this.load.atlas('unity2_6_3_btn',window.baseUrl+'assets/commonAssets2/btn.png',window.baseUrl+'json/gradeJson/2.6.3/btn.json');
        this.load.atlas('unity2_6_3_replay', window.baseUrl+'assets/commonAssets2/reply.png', window.baseUrl+'json/gradeJson/2.6.3/reply.json');
	...
	addunitygame3_1_1BAssets:function()
	{
        ...
        this.load.atlas('unity3_1_2speaker',window.baseUrl+'assets/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/3.1.2/speaker.json');
		this.load.atlas('unity3_1_2starAnim',window.baseUrl+'assets/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/3.1.2/starAnim.json');
        this.load.atlas('unity3_1_2btn',window.baseUrl+'assets/commonAssets/btn.png',window.baseUrl+'json/gradeJson/3.1.2/btn.json');
        this.load.atlas('unity3_1_2replay', window.baseUrl+'assets/commonAssets/reply.png', window.baseUrl+'json/gradeJson/3.1.2/reply.json');
	...
	addunitygame4_4_1Assets:function()
	{
		...
		this.load.image('Level42B_timer',window.baseUrl+'assets/commonAssets/timebg.png');

      
        this.load.atlas('CommonBackBtn',window.baseUrl+'assets/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/4.4.1/backbtn.json');
        this.load.atlas('CommonSpeakerBtn',window.baseUrl+'assets/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/4.4.1/speaker.json');
        this.load.atlas('starAnim',window.baseUrl+'assets/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/4.4.1/starAnim.json');
        this.load.atlas('btn',window.baseUrl+'assets/commonAssets/btn.png',window.baseUrl+'json/gradeJson/4.4.1/btn.json');
        this.load.image('bg3',window.baseUrl+'assets/commonAssets/bg3.png');
        this.load.image('tittleBaar',window.baseUrl+'assets/commonAssets/tittleBaar.png');
        this.load.atlas('replay',window.baseUrl+'assets/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/4.4.1/reply.json');
	...
	{
		this.load.image('Level721_bg1',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/BG.png');
        this.load.atlas('Level721_CommonBackBtn',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/7.2.1/backbtn.json');
        this.load.atlas('Level721_CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/7.2.1/speaker.json');
        this.load.atlas('Level721_starAnim',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/7.2.1/starAnim.json');
        this.load.atlas('Level721_btn',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/btn.png',window.baseUrl+'json/gradeJson/7.2.1/btn.json');
        this.load.image('Level721_bg3',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/bg3.png');
        this.load.image('Level721_tittleBaar',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/tittleBaar.png');
        this.load.atlas('Level721_replay',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/7.2.1/reply.json');
        
        
        this.load.atlas('Level721_tickBtn',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/tick.png' ,window.baseUrl+'json/gradeJson/7.2.1/tick.json');
        this.load.image('Level721_navBar',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/navBar.png');
        this.load.image('Level721_practice',window.baseUrl+'assets/gradeAssets/7.2.1/practice.png');
        this.load.image('Level721_topicOutline',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/topicOutline.png');
        this.load.image('Level721_timebg',window.baseUrl+'assets/gradeAssets/7.2.1/commonAssets/timebg.png');
	...
	{
		this.load.image('Level321_bg1',window.baseUrl+'assets/commonAssets1/BG.png');
        this.load.atlas('Level321_CommonBackBtn',window.baseUrl+'assets/commonAssets1/backbtn.png' ,window.baseUrl+'json/gradeJson/3.2.1/backbtn.json');
        this.load.atlas('Level321_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets1/speaker.png' ,window.baseUrl+'json/gradeJson/3.2.1/speaker.json');
        this.load.atlas('Level321_starAnim',window.baseUrl+'assets/commonAssets1/starAnim.png',window.baseUrl+'json/gradeJson/3.2.1/starAnim.json');
        this.load.atlas('Level321_btn',window.baseUrl+'assets/commonAssets1/btn.png',window.baseUrl+'json/gradeJson/3.2.1/btn.json');
        this.load.image('Level321_bg3',window.baseUrl+'assets/commonAssets1/bg3.png');
        this.load.image('Level321_tittleBaar',window.baseUrl+'assets/commonAssets1/tittleBaar.png');
        this.load.atlas('Level321_replay',window.baseUrl+'assets/commonAssets1/reply.png' ,window.baseUrl+'json/gradeJson/3.2.1/reply.json');
        
        
        this.load.atlas('Level321_tickBtn',window.baseUrl+'assets/commonAssets1/tick.png' ,window.baseUrl+'json/gradeJson/3.2.1/tick.json');
        this.load.image('Level321_navBar',window.baseUrl+'assets/commonAssets1/navBar.png');
        ...
        this.load.image('Level321_topicOutline',window.baseUrl+'assets/commonAssets1/topicOutline.png');
        this.load.image('Level321_timebg',window.baseUrl+'assets/commonAssets1/timebg.png');
	...
	{
		this.load.image('unity11_1bg',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/bg.png');
        this.load.image('unity11_1backg',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/backg.png');
        this.load.image('unity11_1topbar', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/topbar.png');
        this.load.image('unity11_1numbg', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/numbg.png');
        this.load.image('unity11_1timerbg', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/timerbg.png');
        this.load.image('unity11_1dotbox', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/dotbox.png');
        this.load.image('unity11_1tittleBar', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/tittleBaar.png');
		
        this.load.atlas('unity11_1backbtn',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/11.1/backbtn.json');
        this.load.atlas('unity11_1speaker',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/11.1/speaker.json');
        this.load.atlas('unity11_1starAnim',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/11.1/starAnim.json');
        this.load.atlas('unity11_1btn',window.baseUrl+'assets/gradeAssets/11.1/commonAssets/btn.png',window.baseUrl+'json/gradeJson/11.1/btn.json');
        this.load.atlas('unity11_1replay', window.baseUrl+'assets/gradeAssets/11.1/commonAssets/reply.png', window.baseUrl+'json/gradeJson/11.1/reply.json');
	...
	{
		this.load.image('unity11_2bg',window.baseUrl+'assets/gradeAssets/11.2/commonAssets/bg.png');
        this.load.image('unity11_2backg',window.baseUrl+'assets/gradeAssets/11.2/commonAssets/backg.png');
        this.load.image('unity11_2topbar', window.baseUrl+'assets/gradeAssets/11.2/commonAssets/topbar.png');
        this.load.image('unity11_2timerbg', window.baseUrl+'assets/gradeAssets/11.2/commonAssets/timerbg.png');
        this.load.image('unity11_2dotbox', window.baseUrl+'assets/gradeAssets/11.2/commonAssets/dotbox.png');
        this.load.image('unity11_2numbg', window.baseUrl+'assets/gradeAssets/11.2/commonAssets/numbg.png');
        this.load.image('unity11_2tittleBar', window.baseUrl+'assets/gradeAssets/11.2/commonAssets/tittleBaar.png');
	...
	{
		//common for all games.
        this.load.atlas('Unity12_1backbtn',window.baseUrl+'assets/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/12.1/backbtn.json');
        this.load.atlas('Unity12_1CommonSpeakerBtn',window.baseUrl+'assets/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/12.1/speaker.json');
        this.load.atlas('Unity12_1starAnim',window.baseUrl+'assets/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/12.1/starAnim.json');
        this.load.atlas('Unity12_1replay',window.baseUrl+'assets/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/12.1/reply.json');
        this.load.atlas('Unity12_1btn',window.baseUrl+'assets/commonAssets/btn.png',window.baseUrl+'json/gradeJson/12.1/btn.json');
        
        //this.load.image('Unity12_1background',window.baseUrl+'assets/commonAssets/bg.png');
        //this.load.image('Unity12_1tittleBar',window.baseUrl+'assets/commonAssets/tittleBar.png');
        this.load.image('Unity12_1navBar',window.baseUrl+'assets/commonAssets/navBar.png');
        this.load.image('Unity12_1timebg',window.baseUrl+'assets/commonAssets/timebg.png');
        this.load.image('Unity12_1topicOutline',window.baseUrl+'assets/commonAssets/topicOutline.png');
	...
	addunitygame12_2Assets:function()
	{
        ...
        this.load.image('unity12_2tittleBar', window.baseUrl+'assets/commonAssets/tittleBaar.png');
		
        this.load.atlas('unity12_2backbtn',window.baseUrl+'assets/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/12.2/backbtn.json');
        this.load.atlas('unity12_2speaker',window.baseUrl+'assets/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/12.2/speaker.json');
        this.load.atlas('unity12_2starAnim',window.baseUrl+'assets/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/12.2/starAnim.json');
        this.load.atlas('unity12_2btn',window.baseUrl+'assets/commonAssets/btn.png',window.baseUrl+'json/gradeJson/12.2/btn.json');
        this.load.atlas('unity12_2replay', window.baseUrl+'assets/commonAssets/reply.png', window.baseUrl+'json/gradeJson/12.2/reply.json');
	...
	{
		//common for all games.
        this.load.atlas('Unity12_3_1backbtn',window.baseUrl+'assets/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/12.3.1/backbtn.json');
        this.load.atlas('Unity12_3_1CommonSpeakerBtn',window.baseUrl+'assets/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/12.3.1/speaker.json');
        this.load.atlas('Unity12_3_1starAnim',window.baseUrl+'assets/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/12.3.1/starAnim.json');
        this.load.atlas('Unity12_3_1replay',window.baseUrl+'assets/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/12.3.1/reply.json');
        this.load.atlas('Unity12_3_1btn',window.baseUrl+'assets/commonAssets/btn.png',window.baseUrl+'json/gradeJson/12.3.1/btn.json');
        
       // this.load.image('Unity12_3_1background',window.baseUrl+'assets/commonAssets/bg.png');
       // this.load.image('Unity12_3_1tittleBar',window.baseUrl+'assets/commonAssets/tittleBar.png');
        this.load.image('Unity12_3_1navBar',window.baseUrl+'assets/commonAssets/navBar.png');
        this.load.image('Unity12_3_1timebg',window.baseUrl+'assets/commonAssets/timebg.png');
        this.load.image('Unity12_3_1topicOutline',window.baseUrl+'assets/commonAssets/topicOutline.png');
	...
	addunitygame13_1Assets:function()
	{
        ...
        this.load.atlas('CommonBackBtn',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/13.1/backbtn.json');
        this.load.atlas('CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/speaker.png',window.baseUrl+'json/gradeJson/13.1/speaker.json');
        this.load.atlas('starAnim',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/13.1/starAnim.json');
        this.load.atlas('btn',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/btn.png',window.baseUrl+'json/gradeJson/13.1/btn.json');
        this.load.image('bg3',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/bg3.png');
        this.load.image('tittleBaar',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/tittleBaar.png');
        this.load.atlas('replay',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/reply.png' ,window.baseUrl+'json/gradeJson/13.1/reply.json');
        this.load.image('Level13_Topbar',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/Topbar.png');
        this.load.image('Level13_dottedBox', window.baseUrl+'assets/gradeAssets/13.1/commonAssets/dottedBox.png');
        this.load.image('Level13_celeb', window.baseUrl+'assets/gradeAssets/13.1/commonAssets/c.png');
        this.load.image('Level13_practice',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/practice.png');
        this.load.image('Level13_topicOutline',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/topicOutline.png');
        this.load.image('Level13_timebg',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/timebg.png');
        this.load.image('Level13_navBar',window.baseUrl+'assets/gradeAssets/13.1/commonAssets/navBar.png');
        //gameassets
	...
	{
		this.load.image('Level15_1_bg1',window.baseUrl+'assets/commonAssets15_1/BG.png');
        this.load.atlas('grade11_backbtn',window.baseUrl+'assets/commonAssets15_1/backbtn.png' ,window.baseUrl+'json/gradeJson/15.1/backbtn.json');
        this.load.atlas('Level42A_CommonSpeakerBtn',window.baseUrl+'assets/commonAssets15_1/speaker.png' ,window.baseUrl+'json/gradeJson/15.1/speaker.json');
        this.load.atlas('starAnim1',window.baseUrl+'assets/commonAssets15_1/starAnim.png',window.baseUrl+'json/gradeJson/15.1/starAnim.json');
        this.load.atlas('btn',window.baseUrl+'assets/commonAssets15_1/btn.png',window.baseUrl+'json/gradeJson/15.1/btn.json');
        this.load.image('bg3',window.baseUrl+'assets/commonAssets15_1/bg3.png');
        this.load.image('tittleBaar',window.baseUrl+'assets/commonAssets15_1/tittleBaar.png');
        this.load.atlas('replay',window.baseUrl+'assets/commonAssets15_1/reply.png' ,window.baseUrl+'json/gradeJson/15.1/reply.json');
        ...
        this.load.image('Level42A_Topbar',window.baseUrl+'assets/commonAssets15_1/navBar.png');
        this.load.image('Level15_1_numbg',window.baseUrl+'assets/commonAssets15_1/numbg.png');
        ...
        this.load.image('topicOutline',window.baseUrl+'assets/commonAssets/topicOutline.png');*/
        this.load.image('Level42B_timer',window.baseUrl+'assets/commonAssets15_1/timebg.png');
	...
	addunitygame16_1Assets:function()
	{
        ...
        this.load.image('grade161_background',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/bg.png');
		this.load.image('grade161_bg1',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/bg1.png');
        this.load.image('grade161_timebg', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/timebg.png');
        this.load.image('grade161_TopBar', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/Topbar.png');
        this.load.image('grade161_bottomBar', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/bottomBar.png');
        this.load.image('grade161_dottedBox', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/dottedBox.png');
      ...
      //  this.load.atlas('grade61_greenNumbers1',window.baseUrl+'assets/gradeAssets/16.1/gameAssets/greenNumbers1.png' ,window.baseUrl+'json/gradeJson/16.1/greenNumbers1.json');
        ...
        this.load.atlas('grade16_1CommonBackBtn',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/16.1/backbtn.json');
        this.load.atlas('grade16_1CommonSpeakerBtn',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/speaker.png' ,window.baseUrl+'json/gradeJson/16.1/speaker.json');
        this.load.atlas('grade16_1starAnim',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/starAnim.png',window.baseUrl+'json/gradeJson/16.1/starAnim.json');
        this.load.atlas('grade161_btn',window.baseUrl+'assets/gradeAssets/16.1/commonAssets/btn.png',window.baseUrl+'json/gradeJson/16.1/btn.json');
        this.load.image('grade161_tittleBar', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/tittleBar.png');
        this.load.atlas('grade161_replay', window.baseUrl+'assets/gradeAssets/16.1/commonAssets/reply.png', window.baseUrl+'json/gradeJson/16.1/reply.json');
