...
create:function(game)
    {
        ...
        _this.timerbg=_this.add.sprite(305,6,'unity2_6_2_timerbg');
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.2/English/26.2E.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.2/Hindi/26.2H.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.2/Kannada/26.2K.mp3");
                    }
					else
                    {
                         _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.6.2/Odiya/2.6.2.mp3");
