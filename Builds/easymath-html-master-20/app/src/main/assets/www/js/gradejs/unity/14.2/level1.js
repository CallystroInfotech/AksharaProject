    ...
    onDragStop:function(target){//_this.Level14_gridjointvadd  groupvertical
        ...
        if(target.name=="vertical" && _this.flag=="question1"){
           _this.stopflowv1q2=0;
                  ...
                  _this.stopflowv1q2=1;
                    ...
                    if(this.qArrays[_this.no1-1]==4 || this.qArrays[_this.no1-1]==5 || this.qArrays[_this.no1-1]==6){
                        ...
                        if(this.checkOverlap(target,groupvertical.getChildAt(0)) ){
                            ...
                            if(this.checkOverlap(target,groupvertical.getChildAt(6)) ){
                                if(_this.greencubesets==0){
                                    target.x=118;
                                    target.y=275;
                                }else{
                                ...
                                if(this.qArrays[_this.no1-1]==6){
                                    if(this.checkOverlap(target,groupvertical.getChildAt(7)) ){
                                        if(_this.greencubesets==0){
                                            target.x=118;
                                            target.y=275;
                                        }else{
            ...
            if(this.checkOverlap(target,grouphorizontal2.getChildAt(0)) ){
               ...
               _this.dragh2++;
            ...
            else if(this.qArrays[_this.no1-1]==2){
                ...
                _this.dragh2++;
                ...
                else if(this.qArrays[_this.no1-1]==3 || this.qArrays[_this.no1-1]==4 || this.qArrays[_this.no1-1]==5 || this.qArrays[_this.no1-1]==6){
                ...
                }else if(this.qArrays[_this.no1-1]==4 || this.qArrays[_this.no1-1]==5 || this.qArrays[_this.no1-1]==6){
                    ...
                    if(this.checkOverlap(target,grouphorizontal2.getChildAt(7)) ){
                _this.dragh2++;
                }else{
                        _this.stopflowhq2=1;
                    target.x=52;
                ...
                }else if(this.qArrays[_this.no1-1]==6){
            ...
            if(_this.dragh2==0 && _this.dragh2 < _this.secondno && _this.stopflowhq2==0){              ///////240 105
                ...
                _this.horizontalcount=target.y;
                    ...
                    target.x=235;
                    _this.horizontalcount=target.y;
                }else if(_this.dragh2 >= _this.secondno && _this.stopflowhq2==0){
                    target.x=52;
                    target.y=250;
                    _this.wmusic.play();
                }
