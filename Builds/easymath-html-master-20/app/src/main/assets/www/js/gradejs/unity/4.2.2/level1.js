...
Game.unity4_2_2level1.prototype={
    ...
    {
        _this = this;
        //telInitializer.gameIdInit("unity_4_2_2",1);
	...
	create:function(game){
        ...
        _this.timebg = _this.add.sprite(300,6,'Level42C_timer');
    ...
    {  
      ...
      //  _this.qArrays = _this.shuffle( _this.qArrays);
       ...
       /**************************************************************************/ 
        ...
        _this.questionid = "4.2.2#SCR-"+_this.sceneCount;
        
        _this.singlebox = this.add.sprite(416,270,'Level4_22_box','Symbol 6 copy 3 instance 10000');//425,280
        _this.singlebox.scale.setTo(0.9,1.3);//1.2,1.7
        _this.croclessthan = this.add.sprite(325,435,'Level4_22_croc_lessthan','Symbol 2 copy instance 10012');
        _this.croclessthan.scale.setTo(0.95,1.2);
        ...
        _this.crocgreaterthan = this.add.sprite(442,435,'Level4_22_croc_greater','Symbol 2 copy instance 10012');
        _this.crocgreaterthan.scale.setTo(0.95,1.2);
        ...
        _this.croc_watch = this.add.sprite(560,435,'Level4_22_croc_watch','Symbol 3 instance 10000');//560,468
        _this.croc_watch.scale.setTo(0.95,1.2);
        _this.crocwatchanim=_this.croc_watch.animations.add('croc watch');
        _this.crocwatchanim.play(10,true);
        _this.croc_watch.inputEnabled=true;
        _this.croc_watch.name="crocwatch";
        _this.croc_watch.input.enableDrag(true);
        _this.croc_watch.events.onDragStart.add(this.onDragStart, this);
        _this.croc_watch.events.onDragStop.add(this.onDragStop, this);
           ...
           // target.y = 225+(_this.dragrowright*14.8);
            ...
            if(target.name==_this.rightans){
                ...
                if(target.name=="croclessthan"){
                    ...
                    target.inputEnabled=false;
                }else if(target.name=="crocwatch"){
                    target.inputEnabled=false;
                    _this.croc_watch.destroy();
                    _this.croc_watch = this.add.sprite(target.x,target.y,'Level4_22_croc_watch2','Symbol 5 instance 10000');//560,468
                    _this.croc_watch.scale.setTo(1.2,1.7);
                    _this.crocwatchanim=_this.croc_watch.animations.add('croc watch');
