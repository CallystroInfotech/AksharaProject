...
function header(){
    ...
    _this.TopBar=_this.add.sprite(0,0,'Level42C_Topbar');
       ...
       _this.speakerbtn = _this.add.sprite(600,8,'Level42A_CommonSpeakerBtn');
       _this.speakerbtn.inputEnabled = true;
		
		_this.timebg=_this.add.sprite(305,9,'Level42C_timer');
		_this.timebg.scale.setTo(1.2,1);
        (minutes>0?minutes=minutes:minutes=0);
        (seconds>0?seconds=seconds:seconds=0);
  
		_this.timeDisplay = _this.add.text(336,26,minutes+':'+seconds);
