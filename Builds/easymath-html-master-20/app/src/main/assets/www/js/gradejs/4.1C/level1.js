    ...
    {   
        ...
        switch(questno)
        {
            ...
            case 9:if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1A/Hindi/4.1C2.mp3");
                    }
            ...
            case 10:if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.1A/Hindi/4.1C1.mp3");
                    }
                    else if(window.languageSelected == "Kannada")
                    {
