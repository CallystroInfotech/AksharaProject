...
Game.preloader.prototype={
	...
	loadCommonAssets:function()
	{
        ...
        _this.load.audio('spin2', window.baseUrl+'questionSounds/1.4/spin2.mp3');
		...
		this.load.audio('CarrotBite', window.baseUrl+'questionSounds/unity/5.1/English/CarrotBite.mp3');
        this.load.audio('Rabbit', window.baseUrl+'questionSounds/unity/5.1/English/Rabbit.mp3');
        this.load.audio('Tap', window.baseUrl+'questionSounds/unity/5.1/English/Tap.mp3');
        this.load.audio('EHowMany', window.baseUrl+'questionSounds/unity/5.1/English/EHowMany.mp3');
        this.load.audio('HHowMany', window.baseUrl+'questionSounds/unity/5.1/Hindi/HHowMany.mp3');
        this.load.audio('KHowMany', window.baseUrl+'questionSounds/unity/5.1/Kannada/KHowMany.mp3');
        this.load.audio('dragMango', 'sounds/Drag_Snap.mp3');
        this.load.audio('bubble', 'sounds/Bubbles.mp3');
        this.load.audio('bubbleBurst', 'sounds/Bubble Burst.mp3');
        this.load.audio('tap', window.baseUrl+'questionSounds/11.1/English/tap.mp3');
        this.load.audio('coinFall', 'sounds/CoinDrop.mp3');

        this.load.audio('cashOut',window.baseUrl+'questionSounds/7.2.1/CashOut.mp3');
        this.load.audio('WaterDropSplash', 'sounds/WaterDropSplash.mp3');

        this.load.audio('anim1sound', window.baseUrl+'questionSounds/4.6.1/English/Mouse.mp3');
        this.load.audio('anim2sound', window.baseUrl+'questionSounds/4.6.1/English/Elephant.mp3');
	...
	*/
	...
	addgame1_2BAssets:function()
	{
        ...
        this.load.atlas('unity1.2Bbackbtn',window.baseUrl+'assets/gradeAssets/1.2B/commonAssets/backbtn.png' ,window.baseUrl+'json/gradeJson/1.2B/backbtn.json');
