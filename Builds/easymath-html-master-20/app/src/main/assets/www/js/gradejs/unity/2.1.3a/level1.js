...
Game.unity2_1_3alevel1.prototype ={
	...
	create:function(game){
       ...
       /* _this.playQuestionSound = document.createElement('audio');
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.1.3/English/question2.1_Eng.mp3");
        }
        else if(window.languageSelected=="Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.1.3/Hindi/question2.1_Hin.mp3");
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.1.3/Kannada/question2.1_Kan.mp3");
        }
        else
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.1.3/Odiya/2.1.3.mp3");
        }
