...
Game.grade1_2Alevel1.prototype={
	...
	create:function(game){
       ...
       // _this.qArrays2 = _this.shuffle(_this.qArrays2);
		...
		_this.backbtn = _this.add.button(10,7,'unity1.2Abackbtn',function(){console.log("here");},_this,0,1,2);
		...
		_this.backbtn.events.onInputDown.add(function()
		{
		 ...
		 _this.speakerbtn = _this.add.button(610,9,'unity1.2Aspeaker',function(){},this,1,0,2);
	  ...
	  // _this.speakerbtn.inputEnabled = true;
		...
		_this.timebg=this.add.sprite(300,9,'unity1.2Atimerbg');
	...
	generateStarsForTheScene:function(count)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			_this.starsGroup.create(_this.world.centerX-15, 13, 'unity1.2AstarAnim');
...
//timer.setText(minutes + ':'+ seconds );
	...
	{	
		...
		{
			_this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2A/English/1.1A1.mp3");
		}
		else if(window.languageSelected == "Hindi")
		{
			_this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2A/Hindi/1.1A1.mp3");
		}
		else if(window.languageSelected == "Kannada")
		{
			_this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2A/Kannada/1.1A1.mp3");
		}
		else
		{
			_this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2A/Odiya/1.1A1.mp3");
