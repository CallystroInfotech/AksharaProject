...
playDemoVideos:function(target){
		...
		switch(target)
        {
            case '10_1_2a': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/English/Game 10.1.2a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Hindi/Game 10.1.2a.mp3");
							}
							else if(window.languageSelected == "Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Kannada/Game 10.1.2a.mp3");
							}
							else
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Odiya/10.1.2a.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_1_2b': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/English/Game 10.1.2b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Hindi/Game 10.1.2b.mp3");
							}
							else if(window.languageSelected == "Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Kannada/Game 10.1.2b.mp3");
							}
							else
							{
								_this.src.setAttribute("src", window.baseUrl+window.baseUrl+"assets/DemoVOs/Odiya/10.1.2b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
		}				
