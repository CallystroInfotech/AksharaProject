	...
	create:function(game){
      ...
      //  _this.qArray2 = new Array();
       ...
       // _this.qArray2 = _this.shuffle(_this.qArray2);
        ...
        _this.backbtn = _this.add.button(10,7,'unity1.2Bbackbtn',function(){console.log("here");},_this,0,1,2);
       ...
       _this.backbtn.events.onInputDown.add(function()
		{
         ...
         _this.speakerbtn = _this.add.button(610,9,'unity1.2Bspeaker',function(){},this,1,0,2);
	  ...
	  // _this.speakerbtn.inputEnabled = true;
        ...
        _this.timebg=this.add.sprite(300,9,'unity1.2Btimerbg');
  ...
  return array;
    ...
    generateStarsForTheScene:function(count)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            _this.starsGroup.create(_this.world.centerX-15, 13, 'unity1.2BstarAnim');
...
//        scoretext.setText(selctedLang.score+' : '+score);
    ...
    {   
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2B/English/1.1A2.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2B/Hindi/1.1A2.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2B/Kannada/1.1A2.mp3");
        }
		else
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/1.2B/Odiya/1.1A2.mp3");
